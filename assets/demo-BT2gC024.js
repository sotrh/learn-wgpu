...
let od;
let __tla = (async () => {
  const __ = "/learn-wgpu/assets/demo_bg-DJoGRbFp.wasm";
  od = function() {
    d.run_web();
  };
  function e_(_) {
  ...
  function X0(_, e) {
    d.__wasm_bindgen_func_elem_1349(_, e);
  }
  function Y0(_, e, n) {
    d.__wasm_bindgen_func_elem_1342(_, e, c(n));
  }
  function H0(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_3(_, e, c(n));
  }
  function J0(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_4(_, e, c(n));
  }
  function Z0(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_5(_, e, c(n));
  }
  function _u(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_7(_, e, c(n));
  }
  function eu(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_8(_, e, c(n));
  }
  function tu(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_9(_, e, c(n));
  }
  function nu(_, e, n) {
    d.__wasm_bindgen_func_elem_1342_10(_, e, c(n));
  }
  function ru(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_9432(a, _, e, c(n));
  ...
  function bu(_, e, n, r) {
    d.__wasm_bindgen_func_elem_1340(_, e, c(n), c(r));
  }
  function cu(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_2296(a, _, e, c(n));
      var r = w().getInt32(a + 0, true), b = w().getInt32(a + 4, true);
      if (b) throw L(r);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function au(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_2296_11(a, _, e, c(n));
      var r = w().getInt32(a + 0, true), b = w().getInt32(a + 4, true);
      if (b) throw L(r);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function fu(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_2296_12(a, _, e, c(n));
      var r = w().getInt32(a + 0, true), b = w().getInt32(a + 4, true);
      if (b) throw L(r);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : r;
  ...
  }, __), Cu = m.memory, Ru = m.main, qu = m.run_web, Vu = m.__abort_handler, Wu = m.__instance_terminated, Gu = m.__wasm_bindgen_func_elem_9432, Uu = m.__wasm_bindgen_func_elem_1340, ju = m.__wasm_bindgen_func_elem_2296, Ku = m.__wasm_bindgen_func_elem_2296_11, $u = m.__wasm_bindgen_func_elem_2296_12, zu = m.__wasm_bindgen_func_elem_1342, Nu = m.__wasm_bindgen_func_elem_1342_3, Qu = m.__wasm_bindgen_func_elem_1342_4, Xu = m.__wasm_bindgen_func_elem_1342_5, Yu = m.__wasm_bindgen_func_elem_1342_7, Hu = m.__wasm_bindgen_func_elem_1342_8, Ju = m.__wasm_bindgen_func_elem_1342_9, Zu = m.__wasm_bindgen_func_elem_1342_10, _d = m.__wasm_bindgen_func_elem_1349, ed = m.__wbindgen_export, td = m.__wbindgen_export2, nd = m.__wbindgen_export3, rd = m.__wbindgen_export4, bd = m.__wbindgen_export5, cd = m.__wbindgen_add_to_stack_pointer, J = m.__wbindgen_start, ad = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: Vu,
    __instance_terminated: Wu,
    __wasm_bindgen_func_elem_1340: Uu,
    __wasm_bindgen_func_elem_1342: zu,
    __wasm_bindgen_func_elem_1342_10: Zu,
    __wasm_bindgen_func_elem_1342_3: Nu,
    __wasm_bindgen_func_elem_1342_4: Qu,
    __wasm_bindgen_func_elem_1342_5: Xu,
    __wasm_bindgen_func_elem_1342_7: Yu,
    __wasm_bindgen_func_elem_1342_8: Hu,
    __wasm_bindgen_func_elem_1342_9: Ju,
    __wasm_bindgen_func_elem_1349: _d,
    __wasm_bindgen_func_elem_2296: ju,
    __wasm_bindgen_func_elem_2296_11: Ku,
    __wasm_bindgen_func_elem_2296_12: $u,
    __wasm_bindgen_func_elem_9432: Gu,
