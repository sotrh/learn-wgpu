...
let ki;
let __tla = (async () => {
  const b_ = "/learn-wgpu/assets/demo_bg-l_XGPZJv.wasm";
  ki = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function gd(_, e) {
    d.__wasm_bindgen_func_elem_2730(_, e);
  }
  function sd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723(_, e, c(n));
  }
  function wd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_3(_, e, c(n));
  }
  function ld(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_4(_, e, c(n));
  }
  function md(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_5(_, e, c(n));
  }
  function pd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_7(_, e, c(n));
  }
  function xd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_8(_, e, c(n));
  }
  function yd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_9(_, e, c(n));
  }
  function hd(_, e, n) {
    d.__wasm_bindgen_func_elem_2723_10(_, e, c(n));
  }
  function vd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_10987(a, _, e, c(n));
  ...
  function Sd(_, e, n, b) {
    d.__wasm_bindgen_func_elem_2721(_, e, c(n), c(b));
  }
  function Id(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3731(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Ad(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3731_11(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Dd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3731_12(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, b_), bi = m.memory, ri = m.main, ci = m.run_web, ai = m.__abort_handler, fi = m.__instance_terminated, oi = m.__wasm_bindgen_func_elem_10987, ui = m.__wasm_bindgen_func_elem_2721, di = m.__wasm_bindgen_func_elem_3731, ii = m.__wasm_bindgen_func_elem_3731_11, gi = m.__wasm_bindgen_func_elem_3731_12, si = m.__wasm_bindgen_func_elem_2723, wi = m.__wasm_bindgen_func_elem_2723_3, li = m.__wasm_bindgen_func_elem_2723_4, mi = m.__wasm_bindgen_func_elem_2723_5, pi = m.__wasm_bindgen_func_elem_2723_7, xi = m.__wasm_bindgen_func_elem_2723_8, yi = m.__wasm_bindgen_func_elem_2723_9, hi = m.__wasm_bindgen_func_elem_2723_10, vi = m.__wasm_bindgen_func_elem_2730, Si = m.__wbindgen_export, Ii = m.__wbindgen_export2, Ai = m.__wbindgen_export3, Di = m.__wbindgen_export4, Pi = m.__wbindgen_export5, Mi = m.__wbindgen_add_to_stack_pointer, t_ = m.__wbindgen_start, Fi = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: ai,
    __instance_terminated: fi,
    __wasm_bindgen_func_elem_10987: oi,
    __wasm_bindgen_func_elem_2721: ui,
    __wasm_bindgen_func_elem_2723: si,
    __wasm_bindgen_func_elem_2723_10: hi,
    __wasm_bindgen_func_elem_2723_3: wi,
    __wasm_bindgen_func_elem_2723_4: li,
    __wasm_bindgen_func_elem_2723_5: mi,
    __wasm_bindgen_func_elem_2723_7: pi,
    __wasm_bindgen_func_elem_2723_8: xi,
    __wasm_bindgen_func_elem_2723_9: yi,
    __wasm_bindgen_func_elem_2730: vi,
    __wasm_bindgen_func_elem_3731: di,
    __wasm_bindgen_func_elem_3731_11: ii,
    __wasm_bindgen_func_elem_3731_12: gi,
