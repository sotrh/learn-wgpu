...
let Bi;
let __tla = (async () => {
  const b_ = "/learn-wgpu/assets/demo_bg-D6l0VHHX.wasm";
  Bi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function sd(_, e) {
    d.__wasm_bindgen_func_elem_2735(_, e);
  }
  function wd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728(_, e, c(n));
  }
  function ld(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_3(_, e, c(n));
  }
  function md(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_4(_, e, c(n));
  }
  function pd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_5(_, e, c(n));
  }
  function xd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_7(_, e, c(n));
  }
  function yd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_8(_, e, c(n));
  }
  function hd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_9(_, e, c(n));
  }
  function vd(_, e, n) {
    d.__wasm_bindgen_func_elem_2728_10(_, e, c(n));
  }
  function Sd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_10999(a, _, e, c(n));
  ...
  function Id(_, e, n, b) {
    d.__wasm_bindgen_func_elem_2726(_, e, c(n), c(b));
  }
  function Ad(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3738(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Dd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3738_11(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Pd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3738_12(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, b_), ri = m.memory, ci = m.main, ai = m.run_web, fi = m.__abort_handler, oi = m.__instance_terminated, ui = m.__wasm_bindgen_func_elem_10999, di = m.__wasm_bindgen_func_elem_2726, ii = m.__wasm_bindgen_func_elem_3738, gi = m.__wasm_bindgen_func_elem_3738_11, si = m.__wasm_bindgen_func_elem_3738_12, wi = m.__wasm_bindgen_func_elem_2728, li = m.__wasm_bindgen_func_elem_2728_3, mi = m.__wasm_bindgen_func_elem_2728_4, pi = m.__wasm_bindgen_func_elem_2728_5, xi = m.__wasm_bindgen_func_elem_2728_7, yi = m.__wasm_bindgen_func_elem_2728_8, hi = m.__wasm_bindgen_func_elem_2728_9, vi = m.__wasm_bindgen_func_elem_2728_10, Si = m.__wasm_bindgen_func_elem_2735, Ii = m.__wbindgen_export, Ai = m.__wbindgen_export2, Di = m.__wbindgen_export3, Pi = m.__wbindgen_export4, Mi = m.__wbindgen_export5, Fi = m.__wbindgen_add_to_stack_pointer, t_ = m.__wbindgen_start, Ti = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: fi,
    __instance_terminated: oi,
    __wasm_bindgen_func_elem_10999: ui,
    __wasm_bindgen_func_elem_2726: di,
    __wasm_bindgen_func_elem_2728: wi,
    __wasm_bindgen_func_elem_2728_10: vi,
    __wasm_bindgen_func_elem_2728_3: li,
    __wasm_bindgen_func_elem_2728_4: mi,
    __wasm_bindgen_func_elem_2728_5: pi,
    __wasm_bindgen_func_elem_2728_7: xi,
    __wasm_bindgen_func_elem_2728_8: yi,
    __wasm_bindgen_func_elem_2728_9: hi,
    __wasm_bindgen_func_elem_2735: Si,
    __wasm_bindgen_func_elem_3738: ii,
    __wasm_bindgen_func_elem_3738_11: gi,
    __wasm_bindgen_func_elem_3738_12: si,
