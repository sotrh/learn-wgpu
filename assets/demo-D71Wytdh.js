...
let Pd;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-TTTF6rSJ.wasm";
  Pd = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ui(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3092, Li);
    return b(n);
  }
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3092, D);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3092, D);
  ...
  function pi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3092, Bi);
    return b(n);
  }
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4914, ki);
    return b(n);
  }
  function yi(_) {
    return b(_);
  ...
  function ki(_, e, n) {
    i.__wasm_bindgen_func_elem_4915(_, e, b(n));
  }
  function Li(_, e, n, r) {
...
${_.stack}` : r;
  ...
  }, n_), dd = S.memory, gd = S.main, sd = S.run_web, wd = S.__wasm_bindgen_func_elem_3092, ld = S.__wasm_bindgen_func_elem_4914, md = S.__wasm_bindgen_func_elem_3449, pd = S.__wasm_bindgen_func_elem_3447, xd = S.__wasm_bindgen_func_elem_4915, yd = S.__wasm_bindgen_func_elem_3448, hd = S.__wbindgen_export, Sd = S.__wbindgen_export2, vd = S.__wbindgen_export3, Id = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ad = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3092: wd,
    __wasm_bindgen_func_elem_3447: pd,
    __wasm_bindgen_func_elem_3448: yd,
    __wasm_bindgen_func_elem_3449: md,
    __wasm_bindgen_func_elem_4914: ld,
    __wasm_bindgen_func_elem_4915: xd,
