...
let Pd;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-BGrxn9O_.wasm";
  Pd = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ui(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3063, Li);
    return b(n);
  }
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3063, D);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3063, D);
  ...
  function pi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3063, Bi);
    return b(n);
  }
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4885, ki);
    return b(n);
  }
  function yi(_) {
    return b(_);
  ...
  function Bi(_, e) {
    i.__wasm_bindgen_func_elem_3419(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3418(_, e, b(n));
  }
  function ki(_, e, n) {
    i.__wasm_bindgen_func_elem_4886(_, e, b(n));
  }
  function Li(_, e, n, r) {
...
${_.stack}` : r;
  ...
  }, n_), dd = S.memory, gd = S.main, sd = S.run_web, wd = S.__wasm_bindgen_func_elem_3063, ld = S.__wasm_bindgen_func_elem_4885, md = S.__wasm_bindgen_func_elem_3420, pd = S.__wasm_bindgen_func_elem_3418, xd = S.__wasm_bindgen_func_elem_4886, yd = S.__wasm_bindgen_func_elem_3419, hd = S.__wbindgen_export, Sd = S.__wbindgen_export2, vd = S.__wbindgen_export3, Id = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ad = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3063: wd,
    __wasm_bindgen_func_elem_3418: pd,
    __wasm_bindgen_func_elem_3419: yd,
    __wasm_bindgen_func_elem_3420: md,
    __wasm_bindgen_func_elem_4885: ld,
    __wasm_bindgen_func_elem_4886: xd,
