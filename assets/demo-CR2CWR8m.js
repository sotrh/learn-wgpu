...
let $i;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-B_vJppdf.wasm";
  $i = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function zu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4406, ti);
    return c(n);
  }
  function ju(_) {
    return c(_);
  ...
  function ei(_, e) {
    d.__wasm_bindgen_func_elem_2931(_, e);
  }
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2929(_, e, c(n));
  }
  function ti(_, e, n) {
    d.__wasm_bindgen_func_elem_4407(_, e, c(n));
  }
  function ni(_, e, n, r) {
...
${_.stack}` : r;
  ...
  }, n_), Ei = S.memory, Ci = S.main, Oi = S.run_web, Ri = S.__wasm_bindgen_func_elem_2598, qi = S.__wasm_bindgen_func_elem_4406, Gi = S.__wasm_bindgen_func_elem_2937, Vi = S.__wasm_bindgen_func_elem_2929, Wi = S.__wasm_bindgen_func_elem_4407, Ui = S.__wasm_bindgen_func_elem_2931, zi = S.__wbindgen_export, ji = S.__wbindgen_export2, Ki = S.__wbindgen_export3, Ni = S.__wbindgen_export4, e_ = S.__wbindgen_start, Qi = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2598: Ri,
    __wasm_bindgen_func_elem_2929: Vi,
    __wasm_bindgen_func_elem_2931: Ui,
    __wasm_bindgen_func_elem_2937: Gi,
    __wasm_bindgen_func_elem_4406: qi,
    __wasm_bindgen_func_elem_4407: Wi,
