...
let Pd;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-5m656Od1.wasm";
  Pd = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ui(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3081, Li);
    return b(n);
  }
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3081, D);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3081, D);
  ...
  function pi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3081, Bi);
    return b(n);
  }
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4893, ki);
    return b(n);
  }
  function yi(_) {
    return b(_);
  ...
  function Bi(_, e) {
    i.__wasm_bindgen_func_elem_3412(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3414(_, e, b(n));
  }
  function ki(_, e, n) {
    i.__wasm_bindgen_func_elem_4894(_, e, b(n));
  }
  function Li(_, e, n, r) {
    i.__wasm_bindgen_func_elem_3420(_, e, b(n), b(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), dd = S.memory, gd = S.main, sd = S.run_web, wd = S.__wasm_bindgen_func_elem_3081, ld = S.__wasm_bindgen_func_elem_4893, md = S.__wasm_bindgen_func_elem_3420, pd = S.__wasm_bindgen_func_elem_3414, xd = S.__wasm_bindgen_func_elem_4894, yd = S.__wasm_bindgen_func_elem_3412, hd = S.__wbindgen_export, Sd = S.__wbindgen_export2, vd = S.__wbindgen_export3, Id = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ad = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3081: wd,
    __wasm_bindgen_func_elem_3412: yd,
    __wasm_bindgen_func_elem_3414: pd,
    __wasm_bindgen_func_elem_3420: md,
    __wasm_bindgen_func_elem_4893: ld,
    __wasm_bindgen_func_elem_4894: xd,
