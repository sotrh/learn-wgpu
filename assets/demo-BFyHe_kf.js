...
let Xi;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-DI6PV2za.wasm";
  Xi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function Lu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2584, ti);
    return c(n);
  }
  function Eu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2584, D);
    return c(n);
  }
  function Cu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2584, D);
  ...
  function Wu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2584, _i);
    return c(n);
  }
  function Uu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4402, ei);
    return c(n);
  }
  function zu(_) {
    return c(_);
  ...
  function _i(_, e) {
    d.__wasm_bindgen_func_elem_2921(_, e);
  }
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2920(_, e, c(n));
  }
  function ei(_, e, n) {
    d.__wasm_bindgen_func_elem_4403(_, e, c(n));
  }
  function ti(_, e, n, r) {
    d.__wasm_bindgen_func_elem_2922(_, e, c(n), c(r));
  }
  const z = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), Li = S.memory, Ei = S.main, Ci = S.run_web, Oi = S.__wasm_bindgen_func_elem_2584, Ri = S.__wasm_bindgen_func_elem_4402, qi = S.__wasm_bindgen_func_elem_2922, Gi = S.__wasm_bindgen_func_elem_2920, Vi = S.__wasm_bindgen_func_elem_4403, Wi = S.__wasm_bindgen_func_elem_2921, Ui = S.__wbindgen_export, zi = S.__wbindgen_export2, ji = S.__wbindgen_export3, Ki = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ni = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2584: Oi,
    __wasm_bindgen_func_elem_2920: Gi,
    __wasm_bindgen_func_elem_2921: Wi,
    __wasm_bindgen_func_elem_2922: qi,
    __wasm_bindgen_func_elem_4402: Ri,
    __wasm_bindgen_func_elem_4403: Vi,
