...
let $i;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-DzJ1W1Z5.wasm";
  $i = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function Eu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2594, ni);
    return c(n);
  }
  function Cu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2594, D);
    return c(n);
  }
  function Ou(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2594, D);
  ...
  function Uu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2594, ei);
    return c(n);
  }
  function zu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4416, ti);
    return c(n);
  }
  function ju(_) {
    return c(_);
  ...
  function ei(_, e) {
    d.__wasm_bindgen_func_elem_2950(_, e);
  }
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2949(_, e, c(n));
  }
  function ti(_, e, n) {
    d.__wasm_bindgen_func_elem_4417(_, e, c(n));
  }
  function ni(_, e, n, r) {
    d.__wasm_bindgen_func_elem_2951(_, e, c(n), c(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), Ei = S.memory, Ci = S.main, Oi = S.run_web, Ri = S.__wasm_bindgen_func_elem_2594, qi = S.__wasm_bindgen_func_elem_4416, Gi = S.__wasm_bindgen_func_elem_2951, Vi = S.__wasm_bindgen_func_elem_2949, Wi = S.__wasm_bindgen_func_elem_4417, Ui = S.__wasm_bindgen_func_elem_2950, zi = S.__wbindgen_export, ji = S.__wbindgen_export2, Ki = S.__wbindgen_export3, Ni = S.__wbindgen_export4, e_ = S.__wbindgen_start, Qi = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2594: Ri,
    __wasm_bindgen_func_elem_2949: Vi,
    __wasm_bindgen_func_elem_2950: Ui,
    __wasm_bindgen_func_elem_2951: Gi,
    __wasm_bindgen_func_elem_4416: qi,
    __wasm_bindgen_func_elem_4417: Wi,
