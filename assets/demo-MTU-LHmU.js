...
let Md;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-D9hEwg1M.wasm";
  Md = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3146, Ei);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3146, D);
    return b(n);
  }
  function gi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3146, D);
  ...
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3146, ki);
    return b(n);
  }
  function yi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4954, Li);
    return b(n);
  }
  function hi(_) {
    return b(_);
  ...
  function ki(_, e) {
    i.__wasm_bindgen_func_elem_3479(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3477(_, e, b(n));
  }
  function Li(_, e, n) {
    i.__wasm_bindgen_func_elem_4955(_, e, b(n));
  }
  function Ei(_, e, n, r) {
    i.__wasm_bindgen_func_elem_3485(_, e, b(n), b(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), gd = S.memory, sd = S.main, wd = S.run_web, ld = S.__wasm_bindgen_func_elem_3146, md = S.__wasm_bindgen_func_elem_4954, pd = S.__wasm_bindgen_func_elem_3485, xd = S.__wasm_bindgen_func_elem_3477, yd = S.__wasm_bindgen_func_elem_4955, hd = S.__wasm_bindgen_func_elem_3479, Sd = S.__wbindgen_export, vd = S.__wbindgen_export2, Id = S.__wbindgen_export3, Ad = S.__wbindgen_export4, e_ = S.__wbindgen_start, Dd = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3146: ld,
    __wasm_bindgen_func_elem_3477: xd,
    __wasm_bindgen_func_elem_3479: hd,
    __wasm_bindgen_func_elem_3485: pd,
    __wasm_bindgen_func_elem_4954: md,
    __wasm_bindgen_func_elem_4955: yd,
