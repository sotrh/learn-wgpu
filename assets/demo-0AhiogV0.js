...
let $i;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-B1e65iya.wasm";
  $i = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function zu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4402, ti);
    return c(n);
  }
  function ju(_) {
    return c(_);
  ...
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2925(_, e, c(n));
  }
  function ti(_, e, n) {
    d.__wasm_bindgen_func_elem_4403(_, e, c(n));
  }
  function ni(_, e, n, r) {
    d.__wasm_bindgen_func_elem_2933(_, e, c(n), c(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), Ei = S.memory, Ci = S.main, Oi = S.run_web, Ri = S.__wasm_bindgen_func_elem_2594, qi = S.__wasm_bindgen_func_elem_4402, Gi = S.__wasm_bindgen_func_elem_2933, Vi = S.__wasm_bindgen_func_elem_2925, Wi = S.__wasm_bindgen_func_elem_4403, Ui = S.__wasm_bindgen_func_elem_2927, zi = S.__wbindgen_export, ji = S.__wbindgen_export2, Ki = S.__wbindgen_export3, Ni = S.__wbindgen_export4, e_ = S.__wbindgen_start, Qi = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2594: Ri,
    __wasm_bindgen_func_elem_2925: Vi,
    __wasm_bindgen_func_elem_2927: Ui,
    __wasm_bindgen_func_elem_2933: Gi,
    __wasm_bindgen_func_elem_4402: qi,
    __wasm_bindgen_func_elem_4403: Wi,
