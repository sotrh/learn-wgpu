...
let Pd;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-CEFWjpQO.wasm";
  Pd = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ui(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3080, Li);
    return b(n);
  }
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3080, D);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3080, D);
  ...
  function pi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3080, Bi);
    return b(n);
  }
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4888, ki);
    return b(n);
  }
  function yi(_) {
    return b(_);
  ...
  function Bi(_, e) {
    i.__wasm_bindgen_func_elem_3413(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3411(_, e, b(n));
  }
  function ki(_, e, n) {
    i.__wasm_bindgen_func_elem_4889(_, e, b(n));
  }
  function Li(_, e, n, r) {
    i.__wasm_bindgen_func_elem_3419(_, e, b(n), b(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), dd = S.memory, gd = S.main, sd = S.run_web, wd = S.__wasm_bindgen_func_elem_3080, ld = S.__wasm_bindgen_func_elem_4888, md = S.__wasm_bindgen_func_elem_3419, pd = S.__wasm_bindgen_func_elem_3411, xd = S.__wasm_bindgen_func_elem_4889, yd = S.__wasm_bindgen_func_elem_3413, hd = S.__wbindgen_export, Sd = S.__wbindgen_export2, vd = S.__wbindgen_export3, Id = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ad = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3080: wd,
    __wasm_bindgen_func_elem_3411: pd,
    __wasm_bindgen_func_elem_3413: yd,
    __wasm_bindgen_func_elem_3419: md,
    __wasm_bindgen_func_elem_4888: ld,
    __wasm_bindgen_func_elem_4889: xd,
