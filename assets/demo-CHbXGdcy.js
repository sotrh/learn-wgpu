...
let Bi;
let __tla = (async () => {
  const b_ = "/learn-wgpu/assets/demo_bg-JbUyvsUR.wasm";
  Bi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function Sd(_, e, n) {
    try {
      ...
      d.__wasm_bindgen_func_elem_11335(a, _, e, c(n));
  ...
  function Ad(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3369(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Dd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3369_11(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Pd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3369_12(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, b_), ri = m.memory, ci = m.main, ai = m.run_web, fi = m.__abort_handler, oi = m.__instance_terminated, ui = m.__wasm_bindgen_func_elem_11335, di = m.__wasm_bindgen_func_elem_2784, ii = m.__wasm_bindgen_func_elem_3369, gi = m.__wasm_bindgen_func_elem_3369_11, si = m.__wasm_bindgen_func_elem_3369_12, wi = m.__wasm_bindgen_func_elem_2783, li = m.__wasm_bindgen_func_elem_2783_3, mi = m.__wasm_bindgen_func_elem_2783_4, pi = m.__wasm_bindgen_func_elem_2783_5, xi = m.__wasm_bindgen_func_elem_2783_7, yi = m.__wasm_bindgen_func_elem_2783_8, hi = m.__wasm_bindgen_func_elem_2783_9, vi = m.__wasm_bindgen_func_elem_2783_10, Si = m.__wasm_bindgen_func_elem_2785, Ii = m.__wbindgen_export, Ai = m.__wbindgen_export2, Di = m.__wbindgen_export3, Pi = m.__wbindgen_export4, Mi = m.__wbindgen_export5, Fi = m.__wbindgen_add_to_stack_pointer, t_ = m.__wbindgen_start, Ti = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: fi,
    __instance_terminated: oi,
    __wasm_bindgen_func_elem_11335: ui,
    __wasm_bindgen_func_elem_2783: wi,
    __wasm_bindgen_func_elem_2783_10: vi,
    __wasm_bindgen_func_elem_2783_3: li,
    __wasm_bindgen_func_elem_2783_4: mi,
    __wasm_bindgen_func_elem_2783_5: pi,
    __wasm_bindgen_func_elem_2783_7: xi,
    __wasm_bindgen_func_elem_2783_8: yi,
    __wasm_bindgen_func_elem_2783_9: hi,
    __wasm_bindgen_func_elem_2784: di,
    __wasm_bindgen_func_elem_2785: Si,
    __wasm_bindgen_func_elem_3369: ii,
    __wasm_bindgen_func_elem_3369_11: gi,
    __wasm_bindgen_func_elem_3369_12: si,
