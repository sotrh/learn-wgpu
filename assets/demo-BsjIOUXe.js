...
let Xi;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-Ui1lFO5I.wasm";
  Xi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function Lu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2588, ti);
    return c(n);
  }
  function Eu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2588, D);
    return c(n);
  }
  function Cu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2588, D);
  ...
  function Wu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2588, _i);
    return c(n);
  }
  function Uu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4407, ei);
    return c(n);
  }
  function zu(_) {
    return c(_);
  ...
  function _i(_, e) {
    d.__wasm_bindgen_func_elem_2944(_, e);
  }
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2943(_, e, c(n));
  }
  function ei(_, e, n) {
    d.__wasm_bindgen_func_elem_4408(_, e, c(n));
  }
  function ti(_, e, n, r) {
    d.__wasm_bindgen_func_elem_2945(_, e, c(n), c(r));
  }
  const z = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), Li = S.memory, Ei = S.main, Ci = S.run_web, Oi = S.__wasm_bindgen_func_elem_2588, Ri = S.__wasm_bindgen_func_elem_4407, qi = S.__wasm_bindgen_func_elem_2945, Gi = S.__wasm_bindgen_func_elem_2943, Vi = S.__wasm_bindgen_func_elem_4408, Wi = S.__wasm_bindgen_func_elem_2944, Ui = S.__wbindgen_export, zi = S.__wbindgen_export2, ji = S.__wbindgen_export3, Ki = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ni = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2588: Oi,
    __wasm_bindgen_func_elem_2943: Gi,
    __wasm_bindgen_func_elem_2944: Wi,
    __wasm_bindgen_func_elem_2945: qi,
    __wasm_bindgen_func_elem_4407: Ri,
    __wasm_bindgen_func_elem_4408: Vi,
