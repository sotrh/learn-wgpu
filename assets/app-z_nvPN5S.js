const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/demo-BmtMbjr_.js","assets/vite-plugin-wasm-helper-D7K_KhUE.js","assets/demo-5MC8__yq.js","assets/demo-D0zAslvZ.js","assets/demo-J5gIIIoh.js","assets/demo-MTU-LHmU.js","assets/demo-CvQqtvjr.js","assets/demo-Dd4A1vbd.js","assets/demo-Dnwga5ml.js","assets/demo-CoKSLaTj.js","assets/demo-CgpEnewa.js","assets/demo-CHinvOCP.js","assets/demo-0AhiogV0.js","assets/demo-CR2CWR8m.js","assets/demo-Co73d-zR.js","assets/demo-DgtABY1q.js"])))=>i.map(i=>d[i]);
let En, Lf, se, Z, A_, nn, le, F, ys, Le;
let __tla = (async () => {
  function as(e) {
  ...
  const ye = {}, Rn = [], xt = () => {
    ...
    const n = e.indexOf(t);
    n > -1 && e.splice(n, 1);
  }, Dc = Object.prototype.hasOwnProperty, ge = (e, t) => Dc.call(e, t), oe = Array.isArray, On = (e) => mr(e) === "[object Map]", bl = (e) => mr(e) === "[object Set]", qs = (e) => mr(e) === "[object Date]", ie = (e) => typeof e == "function", Ie = (e) => typeof e == "string", vt = (e) => typeof e == "symbol", pe = (e) => e !== null && typeof e == "object", yl = (e) => (pe(e) || ie(e)) && ie(e.then) && ie(e.catch), El = Object.prototype.toString, mr = (e) => El.call(e), Mc = (e) => mr(e).slice(8, -1), wl = (e) => mr(e) === "[object Object]", no = (e) => Ie(e) && e !== "NaN" && e[0] !== "-" && "" + parseInt(e, 10) === e, dn = as(",key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted"), ro = (e) => {
    const t = /* @__PURE__ */ Object.create(null);
  ...
  function To(e) {
    ...
    return t && !Ie(t) && (e.class = Xe(t)), n && (e.style = Bn(n)), e;
  }
  ...
  function fs(e, t) {
    ...
    if (n = oe(e), r = oe(t), n || r) return n && r ? Kc(e, t) : false;
  ...
  const Al = (e) => !!(e && e.__v_isRef === true), xe = (e) => Ie(e) ? e : e == null ? "" : oe(e) || pe(e) && (e.toString === El || !ie(e.toString)) ? Al(e) ? xe(e.value) : JSON.stringify(e, Cl, 2) : String(e), Cl = (e, t) => Al(t) ? Cl(e, t.value) : On(t) ? {
    [`Map(${t.size})`]: [
      ...t.entries()
  ...
  } : vt(t) ? Ao(t) : pe(t) && !oe(t) && !wl(t) ? String(t) : t, Ao = (e, t = "") => {
    var n;
  ...
  class qc {
    constructor(t = false) {
      this.detached = t, this._active = true, this._on = 0, this.effects = [], this.cleanups = [], this._isPaused = false, this.__v_skip = true, this.parent = ze, !t && ze && (this.index = (ze.scopes || (ze.scopes = [])).push(this) - 1);
    }
    get active() {
      return this._active;
    }
  ...
  const Ur = /* @__PURE__ */ new WeakMap(), hn = Symbol(""), Go = Symbol(""), ir = Symbol("");
  function Ge(e, t, n) {
    if (mt && Se) {
      let r = Ur.get(e);
  ...
  function Dt(e, t, n, r, o, s) {
    ...
    if (ds(), t === "clear") i.forEach(l);
      ...
      if (a && n === "length") {
        ...
        case "add":
          a ? u && l(i.get("length")) : (l(i.get(hn)), On(e) && l(i.get(Go)));
          break;
        case "delete":
          a || (l(i.get(hn)), On(e) && l(i.get(Go)));
          break;
        case "set":
          On(e) && l(i.get(hn));
          break;
  ...
  function wn(e) {
    const t = he(e);
    return t === e ? t : (Ge(t, "iterate", ir), at(e) ? t : t.map(_t));
  }
  function lo(e) {
    return Ge(e = he(e), "iterate", ir), e;
  }
  function Yt(e, t) {
  ...
  const Zc = {
    ...
    concat(...e) {
      return wn(this).concat(...e.map((t) => oe(t) ? wn(t) : t));
    },
    entries() {
  ...
  class Ml {
    ...
    get(t, n, r) {
      ...
      if ((vt(n) ? Dl.has(n) : tu(n)) || (o || Ge(t, "get", n), s)) return l;
      if (ke(l)) {
        const a = i && no(n) ? l : l.value;
        return o && pe(a) ? _n(a) : a;
      }
      return pe(l) ? o ? _n(l) : vn(l) : l;
    }
  }
  class $l extends Ml {
    constructor(t = false) {
    ...
    has(t, n) {
      ...
      return (!vt(n) || !Dl.has(n)) && Ge(t, "has", n), r;
    }
    ownKeys(t) {
      return Ge(t, "iterate", oe(t) ? "length" : hn), Reflect.ownKeys(t);
    }
  }
  class Hl extends Ml {
    constructor(t = false) {
  ...
  function lu(e, t, n) {
    return function(...r) {
      ...
      return !t && Ge(s, "iterate", a ? Go : hn), De(Object.create(u), {
        next() {
  ...
  function au(e, t) {
    const n = {
      get(o) {
        ...
        e || (Xt(o, l) && Ge(i, "get", o), Ge(i, "get", l));
      ...
      get size() {
        ...
        return !e && Ge(he(o), "iterate", hn), o.size;
      },
      has(o) {
        const s = this.__v_raw, i = he(s), l = he(o);
        return e || (Xt(o, l) && Ge(i, "has", o), Ge(i, "has", l)), o === l ? s.has(o) : s.has(o) || s.has(l);
      },
      forEach(o, s) {
        const i = this, l = i.__v_raw, a = he(l), u = t ? Ko : e ? Mn : _t;
        return !e && Ge(a, "iterate", hn), l.forEach((c, f) => o.call(s, u(c), u(f), i));
      }
    };
    return De(n, e ? {
      add: xr("add"),
  ...
  const _t = (e) => pe(e) ? vn(e) : e, Mn = (e) => pe(e) ? _n(e) : e;
  function ke(e) {
  ...
  function Kl(e, t, n) {
    return ke(e) ? e : ie(e) ? new Eu(e) : pe(e) && arguments.length > 1 ? wu(e, t, n) : Ke(e);
  }
  function wu(e, t, n) {
    return new yu(e, t, n);
  }
  ...
  function Cu(e, t, n = ye) {
    ...
    if (ke(e) ? (f = () => e.value, y = at(e)) : Zt(e) ? (f = () => u(e), y = true) : oe(e) ? (_ = true, y = e.some((v) => Zt(v) || at(v)), f = () => e.map((v) => {
  ...
  function Mt(e, t = 1 / 0, n) {
    ...
    else if (oe(e)) for (let r = 0; r < e.length; r++) Mt(e[r], t, n);
  ...
  function ms(e) {
    if (!(e.flags & 1)) {
      const t = lr(e), n = Qe[Qe.length - 1];
      !n || !(e.flags & 2) && t >= lr(n) ? Qe.push(e) : Qe.splice(Lu(t), 0, e), e.flags |= 1, Yl();
    }
  }
  function Yl() {
    zr || (zr = ql.then(Jl));
  ...
  function Ru(e) {
    oe(e) ? Pn.push(...e) : Jt && e.id === -1 ? Jt.splice(An + 1, 0, e) : e.flags & 1 || (Pn.push(e), e.flags |= 1), Yl();
  }
  ...
  function Jl(e) {
    try {
      ...
      Tt = -1, Qe.length = 0, Gr(), zr = null, (Qe.length || Pn.length) && Jl();
    }
  }
  let je = null, Ql = null;
  function Kr(e) {
    const t = je;
    return je = e, Ql = e && e.type.__scopeId || null, t;
  }
  Le = function(e, t = je, n) {
    if (!t || e._n) return e;
    const r = (...o) => {
      r._d && Qr(-1);
      const s = Kr(t);
  ...
  const Ou = Symbol.for("v-scx"), Pu = () => Be(Ou);
  function Iu(e, t) {
    return gs(e, null, t);
  }
  function qe(e, t, n) {
  ...
  const ut = [
    ...
    setup(e, { slots: t }) {
      ...
      return () => {
        ...
        if (c && c.type !== Ve && !un(c, a) && ra(n).type !== Ve) {
          let f = ar(c, i, r, n);
          if (bn(c, f), l === "out-in" && a.type !== Ve) return r.isLeaving = true, f.afterLeave = () => {
  ...
  function ar(e, t, n, r, o) {
    const { appear: s, mode: i, persisted: l = false, onBeforeEnter: a, onEnter: u, onAfterEnter: c, onEnterCancelled: f, onBeforeLeave: h, onLeave: p, onAfterLeave: y, onLeaveCancelled: _, onBeforeAppear: w, onAppear: R, onAfterAppear: S, onAppearCancelled: g } = t, v = String(e.key), $ = sa(n, e), Y = (L, k) => {
      ...
      const W = k[1];
      Y(L, k), oe(L) ? L.every((E) => E.length <= 1) && W() : L.length <= 1 && W();
    }, T = {
      mode: i,
      persisted: l,
      beforeEnter(L) {
  ...
  function In(e, t, n, r, o = false) {
    if (oe(e)) {
      e.forEach((_, w) => In(_, t && (oe(t) ? t[w] : t), n, r, o));
      return;
    }
    if (pn(r) && !o) {
      ...
      if (_ || w) {
        const R = () => {
          if (e.f) {
            ...
            if (o) oe(S) && us(S, s);
            else if (oe(S)) S.includes(s) || S.push(s);
            else if (_) c[a] = [
              s
            ], p(a) && (f[a] = c[a]);
            else {
      ...
      switch (W) {
        ...
        case tr:
          if (L && (g = s(g), j = g.nodeType), j === 1 || j === 3) {
            x = g;
            const X = !v.children.length;
            for (let U = 0; U < v.staticCount; U++) X && (v.children += x.nodeType === 1 ? x.outerHTML : x.data), U === v.staticCount - 1 && (v.anchor = x), x = s(x);
            return L ? s(x) : x;
          } else k();
          break;
        case _e:
        ...
        default:
          if (D & 1) (j !== 1 || v.type.toLowerCase() !== g.tagName.toLowerCase()) && !S(g) ? x = k() : x = h(g, v, $, Y, H, T);
            ...
            v.slotScopeIds = H;
            const X = i(g);
            if (L ? x = w(g) : Ln(g) && g.data === "teleport start" ? x = w(g, g.data, "teleport end") : x = s(g), t(v, X, null, $, Y, Rr(X), T), pn(v) && !v.type.__asyncResolved) {
              let U;
              L ? (U = le(_e), U.anchor = x ? x.previousSibling : X.lastChild) : U = g.nodeType === 3 ? nn("") : le("div"), U.el = g, v.component.subTree = U;
            }
...
`) && (Or(g, 0) || Sn(), g.textContent = v.children);
        ...
        if (k) {
          if (j || !T || W & 48) {
            ...
            for (const ce in k) (j && (ce.endsWith("value") || ce === "indeterminate") || pr(ce) && !dn(ce) || ce[0] === "." || U && !dn(ce)) && r(g, ce, null, k[ce], void 0, $);
          } else if (k.onClick) r(g, "onClick", null, k.onClick, void 0, $);
          else if (W & 4 && Zt(k.style)) for (const U in k.style) k.style[U];
        }
        let X;
        (X = k && k.onVnodeBeforeMount) && ft(X, $, v), D && At(v, null, $, "beforeMount"), ((X = k && k.onVnodeMounted) || D || x) && Ra(() => {
          X && ft(X, $, v), x && M.enter(g), D && At(v, null, $, "mounted");
        }, Y);
      }
      ...
      for (let E = 0; E < W; E++) {
        const D = L ? k[E] : k[E] = dt(k[E]), M = D.type === gn;
        g ? (M && !L && E + 1 < W && dt(k[E + 1]).type === gn && (a(o(g.data.slice(D.children.length)), $, s(g)), g.data = D.children), g = f(g, D, Y, H, T, L)) : M && !D.children ? a(D.el = o(""), $) : (Or($, 1) || Sn(), n(null, D, $, null, Y, H, Rr($), T));
      }
      return g;
    }, y = (g, v, $, Y, H, T) => {
  ...
  function tf(e, t) {
    for (let n = 0; n < t.length; n++) {
      const r = t[n];
      if (oe(r)) for (let o = 0; o < r.length; o++) e[r[o].name] = r[o].fn;
  ...
  function Ae(e, t, n = {}, r, o) {
    if (je.ce || je.parent && pn(je.parent) && je.parent.ce) {
      ...
      return t !== "default" && (n.name = t), F(), Pe(_e, null, [
        le("slot", n, r && r())
      ], u ? -2 : 64);
    }
    let s = e[t];
  ...
  function rf(e) {
    ...
    if (u && of(u, r, null), i) for (const X in i) {
      const U = i[X];
      ie(U) && (r[X] = U.bind(n));
    }
    if (o) {
    ...
    if (Yo = true, s) for (const X in s) {
      const U = s[X], ce = ie(U) ? U.bind(n, n) : ie(U.get) ? U.get.bind(n, n) : xt, Ne = !ie(U) && ie(U.set) ? U.set.bind(n) : xt, He = N({
        get: ce,
        set: Ne
      });
    ...
    if (l) for (const X in l) ua(l[X], r, n, X);
    if (a) {
    ...
    c && li(c, e, "c");
    function x(X, U) {
      oe(U) ? U.forEach((ce) => X(ce.bind(n))) : U && X(U.bind(n));
    }
    if (x(Gu, f), x(ct, h), x(Ku, p), x(aa, y), x(Uu, _), x(Wu, w), x(Qu, T), x(Ju, Y), x(Yu, H), x(bs, S), x(ho, v), x(qu, L), oe(k)) if (k.length) {
  ...
  function of(e, t, n = xt) {
    ...
    for (const r in e) {
      const o = e[r];
      let s;
      pe(o) ? "default" in o ? s = Be(o.from || r, o.default, true) : s = Be(o.from || r) : s = Be(o), ke(s) ? Object.defineProperty(t, r, {
        enumerable: true,
        configurable: true,
        get: () => s.value,
        set: (i) => s.value = i
  ...
  function li(e, t, n) {
    bt(oe(e) ? e.map((r) => r.bind(t.proxy)) : e.bind(t.proxy), t, n);
  }
  function ua(e, t, n, r) {
    ...
    if (Ie(e)) {
      const s = t[e];
      ie(s) && qe(o, s);
    } else if (ie(e)) qe(o, e.bind(n));
    else if (pe(e)) if (oe(e)) e.forEach((s) => ua(s, t, n, r));
    else {
  ...
  function ha(e, t, n = false) {
    ...
    return !s && !l ? (pe(e) && r.set(e, null), null) : (oe(s) ? s.forEach((a) => i[a] = null) : De(i, s), pe(e) && r.set(e, i), i);
  }
  function po(e, t) {
  ...
  function Po(e) {
    ...
    return n.dirs && (g = tn(g, null, false, true), g.dirs = g.dirs ? g.dirs.concat(n.dirs) : n.dirs), n.transition && bn(g, n.transition), R = g, Kr(w), R;
  }
  const pf = (e) => {
    let t;
  ...
  function ya(e, t, n = false) {
    ...
    if (oe(s)) for (let c = 0; c < s.length; c++) {
      const f = rt(s[c]);
      fi(f) && (i[f] = ye);
    }
      ...
      const f = rt(c);
      if (fi(f)) {
        const h = s[c], p = i[f] = oe(h) || ie(h) ? {
          type: h
        } : De({}, h), y = p.type;
        let _ = false, w = true;
        if (oe(y)) for (let R = 0; R < y.length; ++R) {
  ...
  const Es = (e) => e === "_" || e === "_ctx" || e === "$stable", ws = (e) => oe(e) ? e.map(dt) : [
    dt(e)
  ], yf = (e, t, n) => {
    if (t._n) return t;
  ...
  function Tf(e, t) {
    const n = oo();
    n.__VUE__ = true;
    const { insert: r, remove: o, patchProp: s, createElement: i, createText: l, createComment: a, setText: u, setElementText: c, parentNode: f, nextSibling: h, setScopeId: p = xt, insertStaticContent: y } = e, _ = (d, m, b, O = null, A = null, P = null, G = void 0, B = null, V = !!m.dynamicChildren) => {
      if (d === m) return;
      d && !un(d, m) && (O = C(d), Ue(d, A, P, true), d = null), m.patchFlag === -2 && (V = false, m.dynamicChildren = null);
      const { type: I, ref: re, shapeFlag: q } = m;
      switch (I) {
        case gn:
          w(d, m, b, O);
          break;
        ...
        case _e:
          ...
          break;
        default:
          q & 1 ? $(d, m, b, O, A, P, G, B, V) : q & 6 ? D(d, m, b, O, A, P, G, B, V) : (q & 64 || q & 128) && I.process(d, m, b, O, A, P, G, B, V, te);
      }
      re != null && A ? In(re, d && d.ref, P, m || d, !m) : re == null && d && d.ref != null && In(d.ref, null, P, d, true);
    }, w = (d, m, b, O) => {
      ...
      if (m.type === "svg" ? G = "svg" : m.type === "math" && (G = "mathml"), d == null) Y(m, b, O, A, P, G, B, V);
      else {
        const I = d.el && d.el._isVueCE ? d.el : null;
        try {
          I && I._beginPatch(), L(d, m, A, P, G, B, V);
        } finally {
          I && I._endPatch();
        }
      }
      ...
      let V, I;
      const { props: re, shapeFlag: q, transition: ne, dirs: ae } = d;
      if (V = d.el = i(d.type, P, re && re.is, re), q & 8 ? c(V, d.children) : q & 16 && T(d.children, V, null, O, A, Io(d, P), G, B), ae && At(d, null, O, "created"), H(V, d, d.scopeId, G, O), re) {
        for (const we in re) we !== "value" && !dn(we) && s(V, we, null, re[we], P, O);
        "value" in re && s(V, "value", null, re.value, P), (I = re.onVnodeBeforeMount) && ft(I, O, d);
      }
      ae && At(d, null, O, "beforeMount");
      const de = Ta(A, ne);
      de && ne.beforeEnter(V), r(V, m, b), ((I = re && re.onVnodeMounted) || de || ae) && nt(() => {
        I && ft(I, O, d), de && ne.enter(V), ae && At(d, null, O, "mounted");
      }, A);
    }, H = (d, m, b, O, A) => {
    ...
    }, T = (d, m, b, O, A, P, G, B, V = 0) => {
      for (let I = V; I < d.length; I++) {
        const re = d[I] = B ? Nt(d[I]) : dt(d[I]);
        _(null, re, m, b, O, A, P, G, B);
      }
    }, L = (d, m, b, O, A, P, G) => {
      const B = m.el = d.el;
      ...
      let ae;
      if (b && on(b, false), (ae = ne.onVnodeBeforeUpdate) && ft(ae, b, m, d), re && At(m, d, b, "beforeUpdate"), b && on(b, true), (q.innerHTML && ne.innerHTML == null || q.textContent && ne.textContent == null) && c(B, ""), I ? k(d.dynamicChildren, I, B, b, O, Io(m, A), P) : G || U(d, m, B, null, b, O, Io(m, A), P, false), V > 0) {
        if (V & 16) W(B, q, ne, b, A);
        else if (V & 2 && q.class !== ne.class && s(B, "class", null, ne.class, A), V & 4 && s(B, "style", q.style, ne.style, A), V & 8) {
          const de = m.dynamicProps;
          for (let we = 0; we < de.length; we++) {
            const ve = de[we], tt = q[ve], We = ne[ve];
            (We !== tt || ve === "value") && s(B, ve, tt, We, A, b);
          }
        }
        V & 1 && d.children !== m.children && c(B, m.children);
      } else !G && I == null && W(B, q, ne, b, A);
      ((ae = ne.onVnodeUpdated) || re) && nt(() => {
        ae && ft(ae, b, m, d), re && At(m, d, b, "updated");
      }, O);
    }, k = (d, m, b, O, A, P, G) => {
      for (let B = 0; B < m.length; B++) {
        const V = d[B], I = m[B], re = V.el && (V.type === _e || !un(V, I) || V.shapeFlag & 198) ? f(V.el) : b;
        _(V, I, re, null, O, A, P, G, true);
      }
    }, W = (d, m, b, O, A) => {
      if (m !== b) {
        if (m !== ye) for (const P in m) !dn(P) && !(P in b) && s(d, P, m[P], null, A, O);
        for (const P in b) {
          if (dn(P)) continue;
          const G = b[P], B = m[P];
      ...
      const I = m.el = d ? d.el : l(""), re = m.anchor = d ? d.anchor : l("");
      let { patchFlag: q, dynamicChildren: ne, slotScopeIds: ae } = m;
      ae && (B = B ? B.concat(ae) : ae), d == null ? (r(I, b, O), r(re, b, O), T(m.children || [], b, re, A, P, G, B, V)) : q > 0 && q & 64 && ne && d.dynamicChildren && d.dynamicChildren.length === ne.length ? (k(d.dynamicChildren, ne, b, A, P, G, B), (m.key != null || A && m === A.subTree) && Aa(d, m, true)) : U(d, m, b, re, A, P, G, B, V);
    }, D = (d, m, b, O, A, P, G, B, V) => {
      m.slotScopeIds = B, d == null ? m.shapeFlag & 512 ? A.ctx.activate(m, b, O, G, V) : M(m, b, O, A, P, G, V) : j(d, m, V);
    }, M = (d, m, b, O, A, P, G) => {
      const B = d.component = If(d, O, A);
      if (br(d) && (B.ctx.renderer = te), kf(B, false, G), B.asyncDep) {
        if (A && A.registerDep(B, x, G), !d.el) {
          const V = B.subTree = le(Ve);
          R(null, V, m, b), d.placeholder = V.el;
        }
      ...
      const B = () => {
        if (d.isMounted) {
          let { next: q, bu: ne, u: ae, parent: de, vnode: we } = d;
          {
            const st = Ca(d);
            if (st) {
              q && (q.el = we.el, X(d, q, G)), st.asyncDep.then(() => {
                nt(() => {
                  d.isUnmounted || I();
                }, A);
              });
          ...
          let ve = q, tt;
          on(d, false), q ? (q.el = we.el, X(d, q, G)) : q = we, ne && So(ne), (tt = q.props && q.props.onVnodeBeforeUpdate) && ft(tt, de, q, we), on(d, true);
          const We = Po(d), pt = d.subTree;
          d.subTree = We, _(pt, We, f(pt.el), C(pt), d, A, P), q.el = We.el, ve === null && ma(d, We.el), ae && nt(ae, A), (tt = q.props && q.props.onVnodeUpdated) && nt(() => ft(tt, de, q, we), A);
        } else {
          let q;
          const { el: ne, props: ae } = m, { bm: de, m: we, parent: ve, root: tt, type: We } = d, pt = pn(m);
          if (on(d, false), de && So(de), !pt && (q = ae && ae.onVnodeBeforeMount) && ft(q, ve, m), on(d, true), ne && be) {
            const st = () => {
              d.subTree = Po(d), be(ne, d.subTree, d, A, null);
            };
            pt && We.__asyncHydrate ? We.__asyncHydrate(ne, d, st) : st();
          } else {
            tt.ce && tt.ce._hasShadowRoot() && tt.ce._injectChildStyle(We);
          ...
          (m.shapeFlag & 256 || ve && pn(ve.vnode) && ve.vnode.shapeFlag & 256) && d.a && nt(d.a, A), d.isMounted = true, m = b = O = null;
        }
      };
      d.scope.on();
      const V = d.effect = new xl(B);
      d.scope.off();
      const I = d.update = V.run.bind(V), re = d.job = V.runIfDirty.bind(V);
      re.i = d, re.id = d.uid, V.scheduler = () => ms(re), on(d, true), I();
    }, X = (d, m, b) => {
      m.component = d;
      const O = d.vnode.props;
      d.vnode = m, d.next = null, _f(d, m.props, O, b), wf(d, m.children, b), Vt(), Xs(d), Ft();
    }, U = (d, m, b, O, A, P, G, B, V = false) => {
      const I = d && d.children, re = d ? d.shapeFlag : 0, q = m.children, { patchFlag: ne, shapeFlag: ae } = m;
      if (ne > 0) {
        if (ne & 128) {
          Ne(I, q, b, O, A, P, G, B, V);
          return;
        } else if (ne & 256) {
          ce(I, q, b, O, A, P, G, B, V);
          return;
        }
      }
      ae & 8 ? (re & 16 && et(I, A, P), q !== I && c(b, q)) : re & 16 ? ae & 16 ? Ne(I, q, b, O, A, P, G, B, V) : et(I, A, P, true) : (re & 8 && c(b, ""), ae & 16 && T(q, b, O, A, P, G, B, V));
    }, ce = (d, m, b, O, A, P, G, B, V) => {
      d = d || Rn, m = m || Rn;
      const I = d.length, re = m.length, q = Math.min(I, re);
      let ne;
      for (ne = 0; ne < q; ne++) {
        const ae = m[ne] = V ? Nt(m[ne]) : dt(m[ne]);
        _(d[ne], ae, b, null, A, P, G, B, V);
      }
      I > re ? et(d, A, P, true, false, q) : T(m, b, O, A, P, G, B, V, q);
    }, Ne = (d, m, b, O, A, P, G, B, V) => {
      let I = 0;
      const re = m.length;
      let q = d.length - 1, ne = re - 1;
      for (; I <= q && I <= ne; ) {
        const ae = d[I], de = m[I] = V ? Nt(m[I]) : dt(m[I]);
        if (un(ae, de)) _(ae, de, b, null, A, P, G, B, V);
        else break;
        I++;
      }
      for (; I <= q && I <= ne; ) {
        const ae = d[q], de = m[ne] = V ? Nt(m[ne]) : dt(m[ne]);
        if (un(ae, de)) _(ae, de, b, null, A, P, G, B, V);
        else break;
        q--, ne--;
      }
      if (I > q) {
        if (I <= ne) {
          const ae = ne + 1, de = ae < re ? m[ae].el : O;
          for (; I <= ne; ) _(null, m[I] = V ? Nt(m[I]) : dt(m[I]), b, de, A, P, G, B, V), I++;
        }
      } else if (I > ne) for (; I <= q; ) Ue(d[I], A, P, true), I++;
      else {
        const ae = I, de = I, we = /* @__PURE__ */ new Map();
        for (I = de; I <= ne; I++) {
          const it = m[I] = V ? Nt(m[I]) : dt(m[I]);
          it.key != null && we.set(it.key, I);
        }
        let ve, tt = 0;
        const We = ne - de + 1;
        let pt = false, st = 0;
        const zn = new Array(We);
        for (I = 0; I < We; I++) zn[I] = 0;
        for (I = ae; I <= q; I++) {
          const it = d[I];
          if (tt >= We) {
            Ue(it, A, P, true);
          ...
          else for (ve = de; ve <= ne; ve++) if (zn[ve - de] === 0 && un(it, m[ve])) {
            wt = ve;
            break;
          }
          wt === void 0 ? Ue(it, A, P, true) : (zn[wt - de] = I + 1, wt >= st ? st = wt : pt = true, _(it, m[wt], b, null, A, P, G, B, V), tt++);
        }
        const zs = pt ? Af(zn) : Rn;
        for (ve = zs.length - 1, I = We - 1; I >= 0; I--) {
          const it = de + I, wt = m[it], Gs = m[it + 1], Ks = it + 1 < re ? Gs.el || xa(Gs) : O;
          zn[I] === 0 ? _(null, wt, b, Ks, A, P, G, B, V) : pt && (ve < 0 || I !== zs[ve] ? He(wt, b, Ks, 2) : ve--);
        }
      }
    }, He = (d, m, b, O, A = null) => {
      const { el: P, type: G, transition: B, children: V, shapeFlag: I } = d;
      if (I & 6) {
      ...
      if (G === _e) {
        r(P, m, b);
        for (let q = 0; q < V.length; q++) He(V[q], m, b, O);
        r(d.anchor, m, b);
        return;
      }
      if (G === tr) {
    ...
    }, Ue = (d, m, b, O = false, A = false) => {
      const { type: P, props: G, ref: B, children: V, dynamicChildren: I, shapeFlag: re, patchFlag: q, dirs: ne, cacheIndex: ae } = d;
      if (q === -2 && (A = false), B != null && (Vt(), In(B, null, b, d, true), Ft()), ae != null && (m.renderCache[ae] = void 0), re & 256) {
        m.ctx.deactivate(d);
        return;
      }
      const de = re & 1 && ne, we = !pn(d);
      let ve;
      if (we && (ve = G && G.onVnodeBeforeUnmount) && ft(ve, m, d), re & 6) ot(d.component, b, O);
      else {
        if (re & 128) {
          d.suspense.unmount(b, O);
          return;
        }
        de && At(d, null, m, "beforeUnmount"), re & 64 ? d.type.remove(d, m, b, te, O) : I && !I.hasOnce && (P !== _e || q > 0 && q & 64) ? et(I, m, b, false, true) : (P === _e && q & 384 || !A && re & 16) && et(V, m, b), O && zt(d);
      }
      ...
      if (d.shapeFlag & 1 && A && !A.persisted) {
        const { leave: G, delayLeave: B } = A, V = () => G(b, P);
        B ? B(d.el, P, V) : V();
      } else P();
    }, Gt = (d, m) => {
      let b;
      ...
      const { bum: O, scope: A, job: P, subTree: G, um: B, m: V, a: I } = d;
      di(V), di(I), O && So(O), A.stop(), P && (P.flags |= 8, Ue(G, d, m, b)), B && nt(B, m), nt(() => {
        d.isUnmounted = true;
      }, m);
    }, et = (d, m, b, O = false, A = false, P = 0) => {
      for (let G = P; G < d.length; G++) Ue(d[G], m, b, O, A);
    }, C = (d) => {
    ...
    const z = (d, m, b) => {
      let O;
      d == null ? m._vnode && (Ue(m._vnode, null, null, true), O = m._vnode.component) : _(m._vnode || null, d, m, null, null, null, b), m._vnode = d, K || (K = true, Xs(O), Gr(), K = false);
    }, te = {
      p: _,
      um: Ue,
      m: He,
  ...
  function Aa(e, t, n = false) {
    ...
    if (oe(r) && oe(o)) for (let s = 0; s < r.length; s++) {
      const i = r[s];
      let l = o[s];
      l.shapeFlag & 1 && !l.dynamicChildren && ((l.patchFlag <= 0 || l.patchFlag === 32) && (l = o[s] = Nt(o[s]), l.el = i.el), !n && l.patchFlag !== -2 && Aa(i, l)), l.type === gn && (l.patchFlag === -1 && (l = o[s] = Nt(l)), l.el = i.el), l.type === Ve && !l.el && (l.el = i.el);
    }
  }
  function Af(e) {
    const t = e.slice(), n = [
  ...
  function Ra(e, t) {
    t && t.pendingBranch ? oe(e) ? t.effects.push(...e) : t.effects.push(e) : Ru(e);
  }
  const _e = Symbol.for("v-fgt"), gn = Symbol.for("v-txt"), Ve = Symbol.for("v-cmt"), tr = Symbol.for("v-stc"), nr = [];
  let lt = null;
  F = function(e = false) {
    nr.push(lt = e ? null : []);
  };
  ...
  Z = function(e, t, n, r, o, s) {
    return Oa(se(e, t, n, r, o, s, true));
  };
  ...
  se = function(e, t = null, n = null, r = 0, o = null, s = e === _e ? 0 : 1, i = false, l = false) {
    const a = {
      __v_isVNode: true,
      __v_skip: true,
      type: e,
  ...
  function xf(e, t = null, n = null, r = 0, o = null, s = false) {
    ...
    if (Hf(e) && (e = e.__vccOpts), t) {
      ...
      l && !Ie(l) && (t.class = Xe(l)), pe(a) && (uo(a) && !oe(a) && (a = De({}, a)), t.style = Bn(a));
    }
    const i = Ie(e) ? 1 : La(e) ? 128 : ea(e) ? 64 : pe(e) ? 4 : ie(e) ? 2 : 0;
    return se(e, t, n, r, o, i, s, true);
  }
  function Fr(e) {
  ...
  function tn(e, t, n = false, r = false) {
    const { props: o, ref: s, patchFlag: i, children: l, transition: a } = e, u = t ? Rf(o || {}, t) : o, c = {
      ...
      props: u,
      key: u && Pa(u),
      ref: t && t.ref ? n && s ? oe(s) ? s.concat(Vr(t)) : [
        s,
        Vr(t)
      ] : Vr(t) : s,
      scopeId: e.scopeId,
  ...
  function Ce(e = "", t = false) {
    return t ? (F(), Pe(Ve, null, e)) : le(Ve, null, e);
  }
  function dt(e) {
    return e == null || typeof e == "boolean" ? le(Ve) : oe(e) ? le(_e, null, e.slice()) : ur(e) ? Nt(e) : le(gn, null, String(e));
  }
  function Nt(e) {
  ...
  function Ss(e, t) {
    ...
    if (t == null) t = null;
      ...
      n = 32;
      const o = t._;
      !o && !_a(t) ? t._ctx = je : o === 3 && je && (je.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
    }
    else ie(t) ? (t = {
      default: t,
      _ctx: je
  ...
  function Rf(...e) {
    ...
    for (let n = 0; n < e.length; n++) {
      const r = e[n];
      for (const o in r) if (o === "class") t.class !== r.class && (t.class = Xe([
        t.class,
        r.class
      ]));
        ...
        const s = t[o], i = r[o];
        i && s !== i && !(oe(s) && s.includes(i)) && (t[o] = s ? [].concat(s, i) : i);
      } else o !== "" && (t[o] = r[o]);
    }
    return t;
  }
  ...
  function J(e, t, n) {
    try {
      ...
      return r === 2 ? pe(t) && !oe(t) ? ur(t) ? le(e, null, [
        t
  ...
  const Na = Zo ? (e) => Zo.createHTML(e) : (e) => e, Ff = "http://www.w3.org/2000/svg", jf = "http://www.w3.org/1998/Math/MathML", kt = typeof document < "u" ? document : null, gi = kt && kt.createElement("template"), Bf = {
    ...
    leaveToClass: String
  }, Ma = De({}, na, Da), Uf = (e) => (e.displayName = "Transition", e.props = Ma, e), go = Uf((e, { slots: t }) => J(Mu, $a(e), t)), sn = (e, t = []) => {
    oe(e) ? e.forEach((n) => n(...t)) : e && e(...t);
  }, vi = (e) => e ? oe(e) ? e.some((t) => t.length > 1) : e.length > 1 : false;
  function $a(e) {
    const t = {};
    ...
    return De(t, {
      ...
      onEnterCancelled(E) {
        L(E, false, void 0, true), sn(g, [
          E
        ]);
      },
      onAppearCancelled(E) {
        L(E, true, void 0, true), sn(T, [
          E
        ]);
      },
      onLeaveCancelled(E) {
    ...
    setup(e, { slots: t }) {
      ...
      return aa(() => {
        ...
        if (o = [], s) for (let u = 0; u < s.length; u++) {
          const c = s[u];
          c.el && c.el instanceof Element && (o.push(c), bn(c, ar(c, l, r, n)), Fa.set(c, Ba(c.el)));
        }
        s = t.default ? vs(t.default()) : [];
        for (let u = 0; u < s.length; u++) {
          const c = s[u];
          c.key != null && bn(c, ar(c, l, r, n));
        }
        return le(a, null, s);
      };
    }
  ...
  const Id = "modulepreload", kd = function(e) {
    ...
    [
      "/",
      {
        loader: () => Q(() => import("./index.html-B4-WIBp_.js"), []),
        meta: {
          title: "Introduction"
        }
      }
    ...
    [
      "/todo.html",
      {
        loader: () => Q(() => import("./todo.html-DJmj1BwP.js"), []),
        meta: {
          title: "Coming Soon!"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./pbr-notes.html-TEkjakAB.js"), []),
        meta: {
          title: "Sources"
        }
      }
    ...
    [
      "/showcase/",
      {
        loader: () => Q(() => import("./index.html-B4G3bjBP.js"), []),
        meta: {
          title: "Foreword"
        }
      }
    ...
    [
      "/topics/",
      {
        loader: () => Q(() => import("./index.html-Cqxe3rC-.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-BgAUb-Kp.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-DdAy5xsj.js"), []),
        meta: {
          title: "The Surface"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-DmRuWNyg.js"), []),
        meta: {
          title: "The Pipeline"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-CSqmnPkP.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-BAqUphLm.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-BsFR5Q8d.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-CCxlrthm.js"), []),
        meta: {
          title: "Instancing"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-CfwXHx_5.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-DrLjuWaJ.js"), []),
        meta: {
          title: "Model Loading"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-CeE86F4l.js"), []),
        meta: {
    ...
    [
      "/compute/sorting/",
      {
        loader: () => Q(() => import("./index.html-uOa790CR.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-FlrFuX9-.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-eld4YKHV.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-DcBD44-w.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-Brwasrv2.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-CSyhxuSz.js"), []),
        meta: {
    ...
    [
      "/showcase/alignment/",
      {
        loader: () => Q(() => import("./index.html-BVi8KjhR.js"), []),
        meta: {
    ...
    [
      "/showcase/compute/",
      {
        loader: () => Q(() => import("./index.html-BWedtz61.js"), []),
        meta: {
    ...
    [
      "/showcase/gifs/",
      {
        loader: () => Q(() => import("./index.html-OOqtPMnS.js"), []),
        meta: {
          title: "Creating gifs"
        }
      }
    ...
    [
      "/showcase/imgui-demo/",
      {
        loader: () => Q(() => import("./index.html-DBlWQdUE.js"), []),
        meta: {
    ...
    [
      "/showcase/mipmaps/",
      {
        loader: () => Q(() => import("./index.html-qbXHzunC.js"), []),
        meta: {
          title: "Mipmapping"
        }
      }
    ...
    [
      "/showcase/pong/",
      {
        loader: () => Q(() => import("./index.html-BuVenciz.js"), []),
        meta: {
          title: "Pong"
        }
      }
    ...
    [
      "/showcase/stencil/",
      {
        loader: () => Q(() => import("./index.html-Bvz1P8EQ.js"), []),
        meta: {
    ...
    [
      "/showcase/threading/",
      {
        loader: () => Q(() => import("./index.html-DgUZR48y.js"), []),
        meta: {
    ...
    [
      "/showcase/windowless/",
      {
        loader: () => Q(() => import("./index.html-CCj1OIBX.js"), []),
        meta: {
    ...
    [
      "/news/0.12/",
      {
        loader: () => Q(() => import("./index.html-DuCJx6-l.js"), []),
        meta: {
    ...
    [
      "/news/0.13/",
      {
        loader: () => Q(() => import("./index.html-DyqPwNWC.js"), []),
        meta: {
    ...
    [
      "/news/0.14/",
      {
        loader: () => Q(() => import("./index.html-cHeVCF_g.js"), []),
        meta: {
    ...
    [
      "/news/0.15/",
      {
        loader: () => Q(() => import("./index.html-TLfDzfEi.js"), []),
        meta: {
    ...
    [
      "/news/0.16/",
      {
        loader: () => Q(() => import("./index.html-BzK28HC0.js"), []),
        meta: {
    ...
    [
      "/news/0.17/",
      {
        loader: () => Q(() => import("./index.html-DyfA16Xt.js"), []),
        meta: {
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-RPeGM1gL.js"), []),
        meta: {
    ...
    [
      "/news/22.0/",
      {
        loader: () => Q(() => import("./index.html-BQDcpbO1.js"), []),
        meta: {
    ...
    [
      "/news/24.0/",
      {
        loader: () => Q(() => import("./index.html-C1oJtOYi.js"), []),
        meta: {
          title: "Version 24.0"
        }
      }
    ...
    [
      "/news/25.0/",
      {
        loader: () => Q(() => import("./index.html-5OlfL7O7.js"), []),
        meta: {
          title: "Version 25.0!"
        }
      }
    ...
    [
      "/news/26.0.1/",
      {
        loader: () => Q(() => import("./index.html-D1527dKY.js"), []),
        meta: {
    ...
    [
      "/news/27.0/",
      {
        loader: () => Q(() => import("./index.html-Cxj427bl.js"), []),
        meta: {
    ...
    [
      "/news/28.0/",
      {
        loader: () => Q(() => import("./index.html-BM5909Iz.js"), []),
        meta: {
    ...
    [
      "/news/29.0/",
      {
        loader: () => Q(() => import("./index.html-DG_WPX4k.js"), []),
        meta: {
    ...
    [
      "/news/pre-0.12/",
      {
        loader: () => Q(() => import("./index.html-CgaWY5kZ.js"), []),
        meta: {
          title: "News (Pre 0.12)"
        }
      }
    ...
    [
      ...
      {
        loader: () => Q(() => import("./index.html-IkXeJ6UB.js"), []),
        meta: {
    ...
    [
      "/news/vuepress-v2/",
      {
        loader: () => Q(() => import("./index.html-pjNInrMs.js"), []),
        meta: {
    ...
    [
      "/404.html",
      {
        loader: () => Q(() => import("./404.html-DBUv4IXu.js"), []),
        meta: {
          title: ""
        }
      }
  ...
  function Ah(e, t) {
    ...
    for (const u of e) {
      ...
      for (let f = 0; f < u.length; f++) {
        const h = u[f];
        let p = Je.Segment + (n.sensitive ? Je.BonusCaseSensitive : 0);
        if (h.type === fn.Static) f || (o += "/"), o += h.value.replace(Th, "\\$&"), p += Je.Static;
        else if (h.type === fn.Param) {
          ...
          let g = _ ? `((?:${S})(?:/(?:${S}))*)` : `(${S})`;
          f || (g = w && u.length < 2 ? `(?:/${g})` : "/" + g), w && (g += "?"), o += g, p += Je.Dynamic, w && (p += Je.BonusOptional), _ && (p += Je.BonusRepeatable), S === ".*" && (p += Je.BonusWildcard);
        }
        c.push(p);
      }
      r.push(c);
    ...
    if (n.strict && n.end) {
      const u = r.length - 1;
      r[u][r[u].length - 1] += Je.BonusStrict;
    }
    ...
    function a(u) {
      ...
      for (const h of e) {
        ...
        for (const p of h) if (p.type === fn.Static) c += p.value;
        else if (p.type === fn.Param) {
  ...
  const Dh = fe({
    ...
    useLink: Gi,
    setup(e, { slots: t }) {
      const n = vn(Gi(e)), { options: r } = Be(_o), o = N(() => ({
  ...
  const qi = (e, t, n) => e ?? t ?? n, Vh = fe({
    ...
    setup(e, { attrs: t, slots: n }) {
      const r = Be(os), o = N(() => e.route || r.value), s = Be(Vi, 0), i = N(() => {
        let u = ee(s);
  ...
  const Fh = Vh;
  function jh(e) {
    const t = Rh(e.routes, e), n = e.parseQuery || dh, r = e.stringifyQuery || Hi, o = e.history, s = Jn(), i = Jn(), l = Jn(), a = Te(It);
    let u = It;
    ...
    function ce() {
      return X && a.value !== It ? Promise.resolve() : new Promise((C, K) => {
        j.add([
          C,
          K
        ]);
    ...
    function Ne(C) {
      return X || (X = !C, M(), j.list().forEach(([K, z]) => C ? z(C) : K()), j.reset()), C;
    }
    ...
    const Gt = /* @__PURE__ */ new Set(), ot = {
      ...
      install(C) {
        ...
        Gt.add(C), C.unmount = function() {
          Gt.delete(C), Gt.size < 1 && (u = It, D && D(), D = null, a.value = It, zt = false, X = false), z();
        };
      }
    };
    function et(C) {
  ...
  }, Yh = Symbol(""), is = Te(Nd), kn = Te(Dd), lc = (e, t) => {
    const n = Td(e, t);
  ...
  const Nn = /* @__PURE__ */ new WeakMap(), cc = (...e) => {
    ...
    return o && Nn.has(o) && n in Nn.get(o) ? Nn.get(o)[n] : Be(...e);
  };
  function cp(e, t) {
    var n;
  ...
  const up = (e) => e != null, fp = Object.prototype.toString, dp = (e) => fp.call(e) === "[object Object]", yn = () => {
  };
  function hp(...e) {
    if (e.length !== 1) return Kl(...e);
    const t = e[0];
    return typeof t == "function" ? _n(Gl(() => ({
      get: t,
      set: yn
    }))) : Ke(t);
  }
  ...
  function wp(e, t, n = {}) {
    const { immediate: r = true, immediateCallback: o = false } = n, s = Te(false);
    let i;
    function l() {
  ...
  function Ds(e = false, t = {}) {
    const { truthyValue: n = true, falsyValue: r = false } = t, o = ke(e), s = Te(e);
    function i(l) {
  ...
  function Hs(e, t = {}) {
    const { window: n = ht, ssrWidth: r = Ap() } = t, o = Ar(() => n && "matchMedia" in n && typeof n.matchMedia == "function"), s = Te(typeof r == "number"), i = Te(), l = Te(false), a = (u) => {
      l.value = u.matches;
    };
    return Iu(() => {
      if (s.value) {
  ...
  function tl(e, t = {}) {
    const { controls: n = false, navigator: r = dc } = t, o = Ar(() => r && "permissions" in r), s = Te(), i = typeof e == "string" ? {
      name: e
    } : e, l = Te(), a = () => {
      var c, f;
  ...
  function Cp(e = {}) {
    const { navigator: t = dc, read: n = false, source: r, copiedDuring: o = 1500, legacy: s = false } = e, i = Ar(() => t && "clipboard" in t), l = tl("clipboard-read"), a = tl("clipboard-write"), u = N(() => i.value || s), c = Te(""), f = Te(false), h = wp(() => f.value = false, o, {
      immediate: false
    });
    async function p() {
  ...
  function Vs(e, t, n, r = {}) {
    ...
    const { flush: s = "pre", deep: i = true, listenToStorageChanges: l = true, writeDefaults: a = true, mergeDefaults: u = false, shallow: c, window: f = ht, eventFilter: h, onError: p = (M) => {
      console.error(M);
    }, initOnMounted: y } = r, _ = (c ? Te : Ke)(typeof t == "function" ? t() : t), w = N(() => Ee(e));
    if (!n) try {
  ...
  function Np(e, t = {
    ...
    }), i = Te(t.width), l = Te(t.height), { stop: a } = kp(e, ([f]) => {
  ...
  const rl = 1;
  function Dp(e, t = {}) {
    const { throttle: n = 0, idle: r = 200, onStop: o = yn, onScroll: s = yn, offset: i = {
      left: 0,
      right: 0,
      top: 0,
      bottom: 0
    ...
    const S = Te(false), g = vn({
      ...
      const X = Math.abs(x * j) <= (i.left || 0), U = Math.abs(x * j) + W.clientWidth >= W.scrollWidth - (i.right || 0) - rl;
      E === "flex" && D === "row-reverse" ? (g.left = U, g.right = X) : (g.left = X, g.right = U), p.value = x;
      let ce = W.scrollTop;
  ...
  function $p(e = {}) {
    const { window: t = ht, initialWidth: n = Number.POSITIVE_INFINITY, initialHeight: r = Number.POSITIVE_INFINITY, listenOrientation: o = true, includeScrollbar: s = true, type: i = "inner" } = e, l = Te(n), a = Te(r), u = () => {
    ...
    return Ze("resize", u, c), t && i === "visual" && t.visualViewport && Ze(t.visualViewport, "resize", u, c), o && qe(Hs("(orientation: portrait)"), () => u()), {
      width: l,
      height: a
    };
  }
  ...
  const nm = fe({
    name: "BackToTop",
    setup() {
      const e = ic(), t = Fs(tm), n = Te(), { height: r } = Np(n), { height: o } = $p(), { y: s } = Mp(), i = N(() => (e.value.backToTop ?? true) && s.value > 100), l = N(() => s.value / (r.value - o.value) * 100);
      return ct(() => {
...
See: https://github.com/francoischalifour/medium-zoom`);
    ...
    var n = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, r = window.Promise || function(E) {
      ...
      if (E.background && (L.style.background = E.background), E.container && E.container instanceof Object && (D.container = cn({}, H.container, E.container)), E.template) {
        var M = Br(E.template) ? E.template : document.querySelector(E.template);
        D.template = M;
      }
      return H = cn({}, H, D), g.forEach(function(j) {
      ...
      var j = D.reduce(function(x, X) {
        return [].concat(x, fl(X));
      }, []);
      return j.filter(function(x) {
        ...
        var X = x.type, U = x.listener, ce = x.options;
        j.forEach(function(Ne) {
          Ne.addEventListener(X, U, ce);
        });
      }), k;
    }, c = function() {
      for (var E = arguments.length, D = Array(E), M = 0; M < E; M++) D[M] = arguments[M];
      T.zoomed && y();
      var j = D.length > 0 ? D.reduce(function(x, X) {
        return [].concat(x, fl(X));
      }, []) : g;
      ...
      var E = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, D = E.target, M = function() {
        ...
        if (H.container) if (H.container instanceof Object) x = cn({}, x, H.container), X = x.width - x.left - x.right - H.margin * 2, U = x.height - x.top - x.bottom - H.margin * 2;
        else {
          var ce = Br(H.container) ? H.container : document.querySelector(H.container), Ne = ce.getBoundingClientRect(), He = Ne.width, Ue = Ne.height, zt = Ne.left, Gt = Ne.top;
          x = cn({}, x, {
            width: He,
            height: Ue,
            left: zt,
        ...
        X = X || x.width - H.margin * 2, U = U || x.height - H.margin * 2;
        var ot = T.zoomedHd || T.original, et = ul(ot) ? X : ot.naturalWidth || X, C = ul(ot) ? U : ot.naturalHeight || U, K = ot.getBoundingClientRect(), z = K.top, te = K.left, ue = K.width, be = K.height, d = Math.min(Math.max(ue, et), X) / ue, m = Math.min(Math.max(be, C), U) / be, b = Math.min(d, m), O = (-te + (X - ue) / 2 + H.margin + x.left) / b, A = (-z + (U - be) / 2 + H.margin + x.top) / b, P = "scale(" + b + ") translate3d(" + O + "px, " + A + "px, 0)";
    ...
    Object.prototype.toString.call(t) === "[object Object]" ? H = t : (t || typeof t == "string") && u(t), H = cn({
      margin: 0,
      background: "#fff",
      scrollOffset: 40,
      container: null,
  ...
  const dl = (e, t) => {
    ...
    setup(e, { slots: t }) {
      ...
      return ct(() => {
        r.value = u(), qe(() => e.tabId && $r.value[e.tabId], (c, f) => {
          if (e.tabId && c !== f) {
    ...
    setup(e, { slots: t }) {
      ...
      return ct(() => {
        r.value = u(), qe(() => e.tabId && Bo.value[e.tabId], (c, f) => {
          if (e.tabId && c !== f) {
            const h = e.data.findIndex(({ id: p }) => p === c);
            h !== -1 && (r.value = h);
          }
    ...
    const { frontmatter: e, themeLocale: t } = $e(), n = Ke([]), r = N(() => e.value.sidebarDepth ?? t.value.sidebarDepth ?? 2), o = () => {
      if (r.value <= 0) {
        n.value = [];
        return;
      }
  ...
  const ng = {
    ...
    setup(e) {
      ...
      return (r, o) => n.value.length ? (F(), Z("div", cg, [
        (F(true), Z(_e, null, Bt(n.value, (s) => (F(), Z("div", {
          key: s.title,
          class: "vp-feature"
        }, [
          se("h2", null, xe(s.title), 1),
          se("p", null, xe(s.details), 1)
        ]))), 128))
      ])) : Ce("", true);
    }
  }), fg = [
    ...
    setup(e) {
      return (t, n) => (F(), Pe(ee(Xh), {
        config: e.config
      }, tf({
        before: Le(() => [
          Ae(t.$slots, "before", To(Fr(e.config)))
        ]),
        after: Le(() => [
          Ae(t.$slots, "after", To(Fr(e.config)))
        ]),
        _: 2
      }, [
        t.$slots.default ? {
          name: "default",
          fn: Le(() => [
            Ae(t.$slots, "default", To(Fr(e.config)))
          ]),
          key: "0"
        } : void 0
      ]), 1032, [
    ...
    setup(e) {
      ...
      return (f, h) => (F(), Z("header", pg, [
        le(c),
        o.value ? (F(), Z("h1", mg, xe(o.value), 1)) : Ce("", true),
        s.value ? (F(), Z("p", gg, xe(s.value), 1)) : Ce("", true),
        u.value.length ? (F(), Z("p", vg, [
          (F(true), Z(_e, null, Bt(u.value, (p) => (F(), Pe(Ht, {
            key: p.text,
            class: Xe([
    ...
    setup(e) {
      ...
      return Tr(() => {
        ...
        le(ee(Xp), null, {
          default: Le(() => [
            qr(se("ul", Lg, [
              (F(true), Z(_e, null, Bt(e.config.children, (a) => (F(), Z("li", {
                key: a.text,
                class: "vp-navbar-dropdown-item"
              }, [
                "children" in a ? (F(), Z(_e, {
                  key: 0
                }, [
                  se("h4", Rg, [
                    a.link ? (F(), Pe(Ht, {
                      ...
                      "config",
                      "onFocusout"
                    ])) : (F(), Z("span", Og, xe(a.text), 1))
                  ]),
                  se("ul", Pg, [
                    (F(true), Z(_e, null, Bt(a.children, (u) => (F(), Z("li", {
                      key: u.link,
  ...
  kc = fe({
    ...
    setup(e) {
      const { themeLocale: t } = $e(), n = kg(), r = Dg(), o = Ng(), s = Ke(false), i = N(() => t.value.navbarLabel ?? "site navigation"), l = N(() => [
        ...n.value,
        ...r.value,
        ...o.value
      ]);
      ...
      }), (a, u) => l.value.length ? (F(), Z("nav", {
        key: 0,
        class: "vp-navbar-items",
        "aria-label": i.value
      }, [
        (F(true), Z(_e, null, Bt(l.value, (c) => (F(), Z("div", {
          key: c.text,
          class: "vp-navbar-item"
        }, [
          "children" in c ? (F(), Pe(Ig, {
            key: 0,
            class: Xe({
              mobile: s.value
            }),
  ...
  const Kg = En(Wg, [
    ...
    setup(e) {
      const t = vc("SearchBox") ? ys("SearchBox") : () => null, { themeLocale: n } = $e(), r = ei("navbar"), o = ei("navbar-brand"), s = Ke(0), i = N(() => s.value ? {
        maxWidth: `${s.value}px`
      } : {}), l = (a, u) => {
        var _a2;
  ...
  const rv = En(ev, [
    ...
    setup(e) {
      ...
      return (i, l) => (F(), Z("footer", av, [
        ...
        se("div", uv, [
          ee(s) ? (F(), Z("div", fv, [
            se("span", dv, xe(ee(n).lastUpdatedText ?? ee(s).locale) + ": ", 1),
            se("time", {
              class: "meta-item-info",
              datetime: ee(s).iso,
              "data-allow-mismatch": ""
          ...
          ee(r).length ? (F(), Z("div", pv, [
            se("span", mv, xe(ee(n).contributorsText) + ": ", 1),
            se("span", gv, [
              (F(true), Z(_e, null, Bt(ee(r), (a, u) => (F(), Z(_e, {
                key: u
              }, [
                se("span", {
                  class: "contributor",
    ...
    __name: "VPPage",
    setup(e) {
      return (t, n) => (F(), Z("main", Rv, [
        Ae(t.$slots, "top"),
        se("div", Ov, [
          Ae(t.$slots, "content-top"),
          le(ee(Rs), {
            id: "content"
          }),
          Ae(t.$slots, "content-bottom")
        ]),
        le(_v),
        le(Lv),
        Ae(t.$slots, "bottom")
    ...
    setup(e) {
      ...
      return bs(() => {
        ...
        return F(), Z("li", null, [
          ...
          "children" in e.item && e.item.children.length ? (F(), Pe(Iv, {
            key: 2
          }, {
            default: Le(() => [
              qr(se("ul", Nv, [
                (F(true), Z(_e, null, Bt(e.item.children, (y) => (F(), Pe(p, {
    ...
    setup(e) {
      ...
      }), (r, o) => ee(n).length ? (F(), Z("ul", Mv, [
        (F(true), Z(_e, null, Bt(ee(n), (s) => (F(), Pe(Dv, {
          key: `${s.text}${s.link}`,
          item: s
        }, null, 8, [
          "item"
    ...
    __name: "Layout",
    setup(e) {
      const { frontmatter: t, page: n, themeLocale: r } = $e(), o = N(() => t.value.navbar ?? r.value.navbar ?? true), s = Ws(), i = Ke(false), l = (w) => {
      ...
      return (w, R) => (F(), Z("div", {
        ...
        Ae(w.$slots, "navbar", {}, () => [
          o.value ? (F(), Pe(Zg, {
            ...
            before: Le(() => [
              Ae(w.$slots, "navbar-before")
            ]),
            after: Le(() => [
              Ae(w.$slots, "navbar-after")
            ]),
            _: 3
          })) : Ce("", true)
        ]),
        ...
        Ae(w.$slots, "sidebar", {}, () => [
          le(Vv, null, {
            top: Le(() => [
              Ae(w.$slots, "sidebar-top")
            ]),
            bottom: Le(() => [
              Ae(w.$slots, "sidebar-bottom")
            ]),
            _: 3
          })
        ]),
          ...
          le(ag, {
            ...
            default: Le(() => [
              ee(t).home ? (F(), Pe(Eg, {
                ...
                "content-top": Le(() => [
                  Ae(w.$slots, "page-content-top")
                ]),
                "content-bottom": Le(() => [
                  Ae(w.$slots, "page-content-bottom")
                ]),
                bottom: Le(() => [
                  Ae(w.$slots, "page-bottom")
                ]),
                _: 3
              }))
            ]),
    ...
    setup(e) {
      ...
      return (f, h) => (F(), Z("div", jv, [
        se("main", Bv, [
          se("div", Uv, [
            h[0] || (h[0] = se("h1", null, "404", -1)),
            se("blockquote", null, xe(c.value), 1),
            le(ee(yo), {
              to: l.value
            }, {
              default: Le(() => [
      ...
      async loadExample() {
        ...
        try {
          const t = Object.assign({
            "./wasm/compute/demo.js": () => Q(() => import("./demo-BmtMbjr_.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([0,1])),
            "./wasm/stencil/demo.js": () => Q(() => import("./demo-5MC8__yq.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([2,1])),
            "./wasm/tutorial10_lighting/demo.js": () => Q(() => import("./demo-D0zAslvZ.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([3,1])),
            "./wasm/tutorial11_normals/demo.js": () => Q(() => import("./demo-J5gIIIoh.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([4,1])),
            "./wasm/tutorial12_camera/demo.js": () => Q(() => import("./demo-MTU-LHmU.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([5,1])),
            "./wasm/tutorial13_hdr/demo.js": () => Q(() => import("./demo-CvQqtvjr.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([6,1])),
            "./wasm/tutorial1_window/demo.js": () => Q(() => import("./demo-Dd4A1vbd.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([7,1])),
            "./wasm/tutorial2_surface/demo.js": () => Q(() => import("./demo-Dnwga5ml.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([8,1])),
            "./wasm/tutorial3_pipeline/demo.js": () => Q(() => import("./demo-CoKSLaTj.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([9,1])),
            "./wasm/tutorial4_buffer/demo.js": () => Q(() => import("./demo-CgpEnewa.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([10,1])),
            "./wasm/tutorial5_textures/demo.js": () => Q(() => import("./demo-CHinvOCP.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([11,1])),
            "./wasm/tutorial6_uniforms/demo.js": () => Q(() => import("./demo-0AhiogV0.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([12,1])),
            "./wasm/tutorial7_instancing/demo.js": () => Q(() => import("./demo-CR2CWR8m.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([13,1])),
            "./wasm/tutorial8_depth/demo.js": () => Q(() => import("./demo-Co73d-zR.js").then(async (m) => {
              await m.__tla;
              return m;
            }), __vite__mapDeps([14,1])),
            "./wasm/tutorial9_models/demo.js": () => Q(() => import("./demo-DgtABY1q.js").then(async (m) => {
              await m.__tla;
              return m;
  ...
  function n_(e, t, n, r, o, s) {
    return F(), Z("div", Jv, [
      n.noCanvas ? Ce("", true) : (F(), Z("canvas", Qv)),
      o.loading ? (F(), Z("div", Xv, "Loading WebAssembly Demo...")) : Ce("", true),
      o.exampleStarted && n.noCanvas ? (F(), Z("div", Zv, "WebAssembly Demo Loaded!")) : Ce("", true),
      o.error ? (F(), Z("div", e_, xe(o.error), 1)) : Ce("", true),
      !o.exampleStarted && !n.autoLoad ? (F(), Z("button", {
        key: 4,
  ...
  function d_(e, t, n, r, o, s) {
    return F(), Z("div", null, [
      se("ul", null, [
        (F(true), Z(_e, null, Bt(s.recentFiles, (i, l) => (F(), Z("li", {
          key: i
        }, [
          se("a", {
            href: l.path
  ...
  const h_ = En(u_, [
    ...
    enhance({ app: e }) {
      e.component("WasmExample", r_), e.component("AutoGithubLink", c_), e.component("RecentArticles", h_);
    }
    ...
    Kv,
    m_
  ].map((e) => e.default).filter(Boolean), g_ = JSON.parse('{"base":"/learn-wgpu/","lang":"en-US","title":"Learn Wgpu","description":"","head":[],"locales":{}}');
  let xn, v_, __, b_, y_, E_, w_, S_, T_;
  xn = Te(g_);
  v_ = bh;
  __ = () => {
    const e = jh({
      history: v_(Wa("/learn-wgpu/")),
      routes: [
        {
          name: "vuepress-route",
          path: "/:catchAll(.*)",
  ...
  y_ = (e, t, n) => {
    ...
    })), s = N(() => ln.resolveLayouts(n)), i = N(() => ln.resolveRouteLocale(xn.value.locales, r.value)), l = N(() => ln.resolveSiteLocaleData(xn.value, i.value)), a = N(() => o.value.comp), u = N(() => o.value.data), c = N(() => u.value.frontmatter), f = N(() => ln.resolvePageHeadTitle(u.value, l.value)), h = N(() => ln.resolvePageHead(f.value, c.value, l.value)), p = N(() => ln.resolvePageLang(u.value, l.value)), y = N(() => ln.resolvePageLayout(u.value, s.value)), _ = {
      layouts: s,
      pageData: u,
      pageComponent: a,
      pageFrontmatter: c,
