...
let Xi;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-CtkgjeA8.wasm";
  Xi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function f_(_, e) {
    const n = U(t(e)), r = y(n, d.__wbindgen_export, d.__wbindgen_export2), b = x;
  ...
  function Rb(_, e, n) {
    Uint8Array.prototype.set.call(Y(_, e), t(n));
  }
  function qb(_, e) {
    return t(_).push(t(e));
  }
  ...
  function Ec(_, e) {
    t(_).addressModeU = z[e];
  }
  function Cc(_, e) {
    t(_).addressModeV = z[e];
  }
  function Oc(_, e) {
    t(_).addressModeW = z[e];
  }
  function Rc(_, e) {
    t(_).alpha = t(e);
  }
  ...
  function ku() {
    return o(function(_, e, n, r, b, a) {
      t(_).writeTexture(t(e), Y(n, r), t(b), t(a));
    }, arguments);
  }
  function Lu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2595, ti);
    return c(n);
  }
  function Eu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2595, D);
    return c(n);
  }
  function Cu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2595, D);
  ...
  function Wu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_2595, _i);
    return c(n);
  }
  function Uu(_, e) {
    const n = v(_, e, d.__wasm_bindgen_func_elem_4404, ei);
    return c(n);
  }
  function zu(_) {
    return c(_);
  ...
  function _i(_, e) {
    d.__wasm_bindgen_func_elem_2926(_, e);
  }
  function D(_, e, n) {
    d.__wasm_bindgen_func_elem_2928(_, e, c(n));
  }
  function ei(_, e, n) {
    d.__wasm_bindgen_func_elem_4405(_, e, c(n));
  }
  function ti(_, e, n, r) {
    d.__wasm_bindgen_func_elem_2934(_, e, c(n), c(r));
  }
  const z = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  function p(_, e) {
    return _ = _ >>> 0, vi().subarray(_ / 4, _ / 4 + e);
  }
  function yi(_, e) {
    return _ = _ >>> 0, Ii().subarray(_ / 2, _ / 2 + e);
  }
  function A(_, e) {
    return _ = _ >>> 0, Ai().subarray(_ / 4, _ / 4 + e);
  }
  function hi(_, e) {
    return _ = _ >>> 0, Di().subarray(_ / 1, _ / 1 + e);
  }
  function Si(_, e) {
    return _ = _ >>> 0, Pi().subarray(_ / 2, _ / 2 + e);
  }
  function F(_, e) {
    return _ = _ >>> 0, Mi().subarray(_ / 4, _ / 4 + e);
  }
  function Y(_, e) {
  ...
  let W = 0;
  function Bi(_, e) {
    return W += e, W >= Ti && (V = new TextDecoder("utf-8", {
      ignoreBOM: true,
      fatal: true
    }), V.decode(), W = e), V.decode(T().subarray(_, _ + e));
  }
  ...
  const S = await t_({
    "./demo_bg.js": {
      ...
      __wbg_writeTexture_bf31683b9d6c6d14: ku,
      ...
      __wbindgen_cast_0000000000000001: Lu,
      __wbindgen_cast_0000000000000002: Eu,
      __wbindgen_cast_0000000000000003: Cu,
      __wbindgen_cast_0000000000000004: Ou,
      __wbindgen_cast_0000000000000005: Ru,
      __wbindgen_cast_0000000000000006: qu,
      __wbindgen_cast_0000000000000007: Gu,
      __wbindgen_cast_0000000000000008: Vu,
      __wbindgen_cast_0000000000000009: Wu,
      __wbindgen_cast_000000000000000a: Uu,
      __wbindgen_cast_000000000000000b: zu,
      __wbindgen_cast_000000000000000c: ju,
      __wbindgen_cast_000000000000000d: Ku,
      __wbindgen_cast_000000000000000e: Nu,
      __wbindgen_cast_000000000000000f: Qu,
      __wbindgen_cast_0000000000000010: Xu,
      __wbindgen_cast_0000000000000011: $u,
      __wbindgen_cast_0000000000000012: Yu,
      __wbindgen_cast_0000000000000013: Hu
    }
  }, n_), Li = S.memory, Ei = S.main, Ci = S.run_web, Oi = S.__wasm_bindgen_func_elem_2595, Ri = S.__wasm_bindgen_func_elem_4404, qi = S.__wasm_bindgen_func_elem_2934, Gi = S.__wasm_bindgen_func_elem_2928, Vi = S.__wasm_bindgen_func_elem_4405, Wi = S.__wasm_bindgen_func_elem_2926, Ui = S.__wbindgen_export, zi = S.__wbindgen_export2, ji = S.__wbindgen_export3, Ki = S.__wbindgen_export4, e_ = S.__wbindgen_start, Ni = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_2595: Oi,
    __wasm_bindgen_func_elem_2926: Wi,
    __wasm_bindgen_func_elem_2928: Gi,
    __wasm_bindgen_func_elem_2934: qi,
    __wasm_bindgen_func_elem_4404: Ri,
    __wasm_bindgen_func_elem_4405: Vi,
    __wbindgen_export: Ui,
    __wbindgen_export2: zi,
    __wbindgen_export3: ji,
    __wbindgen_export4: Ki,
    __wbindgen_start: e_,
    main: Ei,
    memory: Li,
    run_web: Ci
