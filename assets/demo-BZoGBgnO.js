...
let Nd;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-DMbXCBXP.wasm";
  Nd = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function Fi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3182, Ji);
    return b(n);
  }
  function Bi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3182, D);
    return b(n);
  }
  function Ti(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3182, D);
  ...
  function Oi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3182, Yi);
    return b(n);
  }
  function qi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_5028, Hi);
    return b(n);
  }
  function Gi(_) {
    return b(_);
  ...
  function Yi(_, e) {
    i.__wasm_bindgen_func_elem_3538(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3537(_, e, b(n));
  }
  function Hi(_, e, n) {
    i.__wasm_bindgen_func_elem_5029(_, e, b(n));
  }
  function Ji(_, e, n, r) {
    i.__wasm_bindgen_func_elem_3539(_, e, b(n), b(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), Td = S.memory, kd = S.main, Ld = S.run_web, Cd = S.__wasm_bindgen_func_elem_3182, Ed = S.__wasm_bindgen_func_elem_5028, Rd = S.__wasm_bindgen_func_elem_3539, Od = S.__wasm_bindgen_func_elem_3537, qd = S.__wasm_bindgen_func_elem_5029, Gd = S.__wasm_bindgen_func_elem_3538, Vd = S.__wbindgen_export, Wd = S.__wbindgen_export2, Ud = S.__wbindgen_export3, zd = S.__wbindgen_export4, e_ = S.__wbindgen_start, jd = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3182: Cd,
    __wasm_bindgen_func_elem_3537: Od,
    __wasm_bindgen_func_elem_3538: Gd,
    __wasm_bindgen_func_elem_3539: Rd,
    __wasm_bindgen_func_elem_5028: Ed,
    __wasm_bindgen_func_elem_5029: qd,
