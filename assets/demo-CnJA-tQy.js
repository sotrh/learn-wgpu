...
let Bi;
let __tla = (async () => {
  const b_ = "/learn-wgpu/assets/demo_bg-CO3H39Yd.wasm";
  Bi = function() {
    d.run_web();
  };
  function r_(_) {
  ...
  function sd(_, e) {
    d.__wasm_bindgen_func_elem_2782(_, e);
  }
  function wd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780(_, e, c(n));
  }
  function ld(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_3(_, e, c(n));
  }
  function md(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_4(_, e, c(n));
  }
  function pd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_5(_, e, c(n));
  }
  function xd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_7(_, e, c(n));
  }
  function yd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_8(_, e, c(n));
  }
  function hd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_9(_, e, c(n));
  }
  function vd(_, e, n) {
    d.__wasm_bindgen_func_elem_2780_10(_, e, c(n));
  }
  function Sd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_11332(a, _, e, c(n));
  ...
  function Id(_, e, n, b) {
    d.__wasm_bindgen_func_elem_2781(_, e, c(n), c(b));
  }
  function Ad(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3366(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Dd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3366_11(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Pd(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3366_12(a, _, e, c(n));
      var b = l().getInt32(a + 0, true), r = l().getInt32(a + 4, true);
      if (r) throw L(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, b_), ri = m.memory, ci = m.main, ai = m.run_web, fi = m.__abort_handler, oi = m.__instance_terminated, ui = m.__wasm_bindgen_func_elem_11332, di = m.__wasm_bindgen_func_elem_2781, ii = m.__wasm_bindgen_func_elem_3366, gi = m.__wasm_bindgen_func_elem_3366_11, si = m.__wasm_bindgen_func_elem_3366_12, wi = m.__wasm_bindgen_func_elem_2780, li = m.__wasm_bindgen_func_elem_2780_3, mi = m.__wasm_bindgen_func_elem_2780_4, pi = m.__wasm_bindgen_func_elem_2780_5, xi = m.__wasm_bindgen_func_elem_2780_7, yi = m.__wasm_bindgen_func_elem_2780_8, hi = m.__wasm_bindgen_func_elem_2780_9, vi = m.__wasm_bindgen_func_elem_2780_10, Si = m.__wasm_bindgen_func_elem_2782, Ii = m.__wbindgen_export, Ai = m.__wbindgen_export2, Di = m.__wbindgen_export3, Pi = m.__wbindgen_export4, Mi = m.__wbindgen_export5, Fi = m.__wbindgen_add_to_stack_pointer, t_ = m.__wbindgen_start, Ti = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: fi,
    __instance_terminated: oi,
    __wasm_bindgen_func_elem_11332: ui,
    __wasm_bindgen_func_elem_2780: wi,
    __wasm_bindgen_func_elem_2780_10: vi,
    __wasm_bindgen_func_elem_2780_3: li,
    __wasm_bindgen_func_elem_2780_4: mi,
    __wasm_bindgen_func_elem_2780_5: pi,
    __wasm_bindgen_func_elem_2780_7: xi,
    __wasm_bindgen_func_elem_2780_8: yi,
    __wasm_bindgen_func_elem_2780_9: hi,
    __wasm_bindgen_func_elem_2781: di,
    __wasm_bindgen_func_elem_2782: Si,
    __wasm_bindgen_func_elem_3366: ii,
    __wasm_bindgen_func_elem_3366_11: gi,
    __wasm_bindgen_func_elem_3366_12: si,
