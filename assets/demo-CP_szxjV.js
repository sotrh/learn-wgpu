...
let kg;
let __tla = (async () => {
  const r_ = "/learn-wgpu/assets/demo_bg-BHGe3-e5.wasm";
  kg = function() {
    d.run_web();
  };
  function c_(_) {
  ...
  function gi(_, e) {
    d.__wasm_bindgen_func_elem_3368(_, e);
  }
  function si(_, e, n) {
    d.__wasm_bindgen_func_elem_3366(_, e, c(n));
  }
  function wi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_3(_, e, c(n));
  }
  function li(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_4(_, e, c(n));
  }
  function mi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_5(_, e, c(n));
  }
  function pi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_7(_, e, c(n));
  }
  function xi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_8(_, e, c(n));
  }
  function yi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_9(_, e, c(n));
  }
  function hi(_, e, n) {
    d.__wasm_bindgen_func_elem_3366_10(_, e, c(n));
  }
  function vi(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_11998(a, _, e, c(n));
  ...
  function Si(_, e, n, b) {
    d.__wasm_bindgen_func_elem_3367(_, e, c(n), c(b));
  }
  function Ii(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3971(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Ai(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3971_11(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
  ...
  function Di(_, e, n) {
    try {
      const a = d.__wbindgen_add_to_stack_pointer(-16);
      d.__wasm_bindgen_func_elem_3971_12(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      d.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, r_), rg = m.memory, cg = m.main, ag = m.run_web, fg = m.__abort_handler, og = m.__instance_terminated, dg = m.__wasm_bindgen_func_elem_11998, ug = m.__wasm_bindgen_func_elem_3367, ig = m.__wasm_bindgen_func_elem_3971, gg = m.__wasm_bindgen_func_elem_3971_11, sg = m.__wasm_bindgen_func_elem_3971_12, wg = m.__wasm_bindgen_func_elem_3366, lg = m.__wasm_bindgen_func_elem_3366_3, mg = m.__wasm_bindgen_func_elem_3366_4, pg = m.__wasm_bindgen_func_elem_3366_5, xg = m.__wasm_bindgen_func_elem_3366_7, yg = m.__wasm_bindgen_func_elem_3366_8, hg = m.__wasm_bindgen_func_elem_3366_9, vg = m.__wasm_bindgen_func_elem_3366_10, Sg = m.__wasm_bindgen_func_elem_3368, Ig = m.__wbindgen_export, Ag = m.__wbindgen_export2, Dg = m.__wbindgen_export3, Pg = m.__wbindgen_export4, Mg = m.__wbindgen_export5, Fg = m.__wbindgen_add_to_stack_pointer, n_ = m.__wbindgen_start, Bg = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: fg,
    __instance_terminated: og,
    __wasm_bindgen_func_elem_11998: dg,
    __wasm_bindgen_func_elem_3366: wg,
    __wasm_bindgen_func_elem_3366_10: vg,
    __wasm_bindgen_func_elem_3366_3: lg,
    __wasm_bindgen_func_elem_3366_4: mg,
    __wasm_bindgen_func_elem_3366_5: pg,
    __wasm_bindgen_func_elem_3366_7: xg,
    __wasm_bindgen_func_elem_3366_8: yg,
    __wasm_bindgen_func_elem_3366_9: hg,
    __wasm_bindgen_func_elem_3367: ug,
    __wasm_bindgen_func_elem_3368: Sg,
    __wasm_bindgen_func_elem_3971: ig,
    __wasm_bindgen_func_elem_3971_11: gg,
    __wasm_bindgen_func_elem_3971_12: sg,
