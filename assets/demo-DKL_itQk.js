...
let Md;
let __tla = (async () => {
  const n_ = "/learn-wgpu/assets/demo_bg-CvhThNSU.wasm";
  Md = function() {
    i.run_web();
  };
  function r_(_) {
  ...
  function ii(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3111, Ei);
    return b(n);
  }
  function di(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3111, D);
    return b(n);
  }
  function gi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3111, D);
  ...
  function xi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_3111, ki);
    return b(n);
  }
  function yi(_, e) {
    const n = v(_, e, i.__wasm_bindgen_func_elem_4932, Li);
    return b(n);
  }
  function hi(_) {
    return b(_);
  ...
  function ki(_, e) {
    i.__wasm_bindgen_func_elem_3448(_, e);
  }
  function D(_, e, n) {
    i.__wasm_bindgen_func_elem_3447(_, e, b(n));
  }
  function Li(_, e, n) {
    i.__wasm_bindgen_func_elem_4933(_, e, b(n));
  }
  function Ei(_, e, n, r) {
    i.__wasm_bindgen_func_elem_3449(_, e, b(n), b(r));
  }
  const j = [
    "clamp-to-edge",
    "repeat",
...
${_.stack}` : r;
  ...
  }, n_), gd = S.memory, sd = S.main, wd = S.run_web, ld = S.__wasm_bindgen_func_elem_3111, md = S.__wasm_bindgen_func_elem_4932, pd = S.__wasm_bindgen_func_elem_3449, xd = S.__wasm_bindgen_func_elem_3447, yd = S.__wasm_bindgen_func_elem_4933, hd = S.__wasm_bindgen_func_elem_3448, Sd = S.__wbindgen_export, vd = S.__wbindgen_export2, Id = S.__wbindgen_export3, Ad = S.__wbindgen_export4, e_ = S.__wbindgen_start, Dd = Object.freeze(Object.defineProperty({
    __proto__: null,
    __wasm_bindgen_func_elem_3111: ld,
    __wasm_bindgen_func_elem_3447: xd,
    __wasm_bindgen_func_elem_3448: hd,
    __wasm_bindgen_func_elem_3449: pd,
    __wasm_bindgen_func_elem_4932: md,
    __wasm_bindgen_func_elem_4933: yd,
