...
var require_stdin = __commonJS({
  "<stdin>"(exports, module) {
    (async () => {
      const c_ = "/learn-wgpu/assets/demo_bg-DTNJHlq4.wasm";
      function r_(_) {
        const e = t(_).Window;
        return b(e);
      }
      ...
      function Td(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_3222, ei);
        return b(n);
      }
      function Bd(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_3222, D);
        return b(n);
      }
      function kd(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_3222, D);
      ...
      function qd(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_3222, Jd);
        return b(n);
      }
      function Gd(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_5071, _i);
        return b(n);
      }
      function Vd(_, e) {
        const n = v(_, e, d.__wasm_bindgen_func_elem_1570, Zd);
        return b(n);
      }
      function Wd(_) {
        return b(_);
      ...
      function Jd(_, e) {
        d.__wasm_bindgen_func_elem_3578(_, e);
      }
      function Zd(_, e) {
        d.__wasm_bindgen_func_elem_1587(_, e);
      }
      function D(_, e, n) {
        d.__wasm_bindgen_func_elem_3577(_, e, b(n));
      }
      function _i(_, e, n) {
        d.__wasm_bindgen_func_elem_5072(_, e, b(n));
      }
      function ei(_, e, n, c) {
        d.__wasm_bindgen_func_elem_3579(_, e, b(n), b(c));
      }
      const j = [
        "clamp-to-edge",
        "repeat",
...
${_.stack}` : c;
      ...
      }, c_), Ei = S.memory, Ci = S.main, Ri = S.__wasm_bindgen_func_elem_3222, Oi = S.__wasm_bindgen_func_elem_5071, qi = S.__wasm_bindgen_func_elem_1570, Gi = S.__wasm_bindgen_func_elem_3579, Vi = S.__wasm_bindgen_func_elem_3577, Wi = S.__wasm_bindgen_func_elem_5072, Ui = S.__wasm_bindgen_func_elem_3578, zi = S.__wasm_bindgen_func_elem_1587, ji = S.__wbindgen_export, Ki = S.__wbindgen_export2, Ni = S.__wbindgen_export3, Qi = S.__wbindgen_export4, t_ = S.__wbindgen_start, Xi = Object.freeze(Object.defineProperty({
        __proto__: null,
        __wasm_bindgen_func_elem_1570: qi,
        __wasm_bindgen_func_elem_1587: zi,
        __wasm_bindgen_func_elem_3222: Ri,
        __wasm_bindgen_func_elem_3577: Vi,
        __wasm_bindgen_func_elem_3578: Ui,
        __wasm_bindgen_func_elem_3579: Gi,
        __wasm_bindgen_func_elem_5071: Oi,
        __wasm_bindgen_func_elem_5072: Wi,
