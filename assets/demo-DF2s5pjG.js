...
let dg;
let __tla = (async () => {
  const b_ = "/learn-wgpu/assets/demo_bg-BDD10wjY.wasm";
  dg = function() {
    u.run_web();
  };
  function r_(_) {
  ...
  function Kd(_, e) {
    u.__wasm_bindgen_func_elem_3288(_, e);
  }
  function $d(_, e, n) {
    u.__wasm_bindgen_func_elem_3286(_, e, c(n));
  }
  function Nd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_3(_, e, c(n));
  }
  function Qd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_4(_, e, c(n));
  }
  function Xd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_5(_, e, c(n));
  }
  function Yd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_7(_, e, c(n));
  }
  function Hd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_8(_, e, c(n));
  }
  function Jd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_9(_, e, c(n));
  }
  function Zd(_, e, n) {
    u.__wasm_bindgen_func_elem_3286_10(_, e, c(n));
  }
  function _i(_, e, n) {
    try {
      const a = u.__wbindgen_add_to_stack_pointer(-16);
      u.__wasm_bindgen_func_elem_11866(a, _, e, c(n));
  ...
  function ei(_, e, n, b) {
    u.__wasm_bindgen_func_elem_3287(_, e, c(n), c(b));
  }
  function ti(_, e, n) {
    try {
      const a = u.__wbindgen_add_to_stack_pointer(-16);
      u.__wasm_bindgen_func_elem_3873(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      u.__wbindgen_add_to_stack_pointer(16);
  ...
  function ni(_, e, n) {
    try {
      const a = u.__wbindgen_add_to_stack_pointer(-16);
      u.__wasm_bindgen_func_elem_3873_11(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      u.__wbindgen_add_to_stack_pointer(16);
  ...
  function bi(_, e, n) {
    try {
      const a = u.__wbindgen_add_to_stack_pointer(-16);
      u.__wasm_bindgen_func_elem_3873_12(a, _, e, c(n));
      var b = w().getInt32(a + 0, true), r = w().getInt32(a + 4, true);
      if (r) throw E(b);
    } finally {
      u.__wbindgen_add_to_stack_pointer(16);
...
${_.stack}` : b;
  ...
  }, b_), qi = m.memory, Gi = m.main, Vi = m.run_web, Wi = m.__abort_handler, Ui = m.__instance_terminated, zi = m.__wasm_bindgen_func_elem_11866, ji = m.__wasm_bindgen_func_elem_3287, Ki = m.__wasm_bindgen_func_elem_3873, $i = m.__wasm_bindgen_func_elem_3873_11, Ni = m.__wasm_bindgen_func_elem_3873_12, Qi = m.__wasm_bindgen_func_elem_3286, Xi = m.__wasm_bindgen_func_elem_3286_3, Yi = m.__wasm_bindgen_func_elem_3286_4, Hi = m.__wasm_bindgen_func_elem_3286_5, Ji = m.__wasm_bindgen_func_elem_3286_7, Zi = m.__wasm_bindgen_func_elem_3286_8, _g = m.__wasm_bindgen_func_elem_3286_9, eg = m.__wasm_bindgen_func_elem_3286_10, tg = m.__wasm_bindgen_func_elem_3288, ng = m.__wbindgen_export, bg = m.__wbindgen_export2, rg = m.__wbindgen_export3, cg = m.__wbindgen_export4, ag = m.__wbindgen_export5, fg = m.__wbindgen_add_to_stack_pointer, t_ = m.__wbindgen_start, og = Object.freeze(Object.defineProperty({
    __proto__: null,
    __abort_handler: Wi,
    __instance_terminated: Ui,
    __wasm_bindgen_func_elem_11866: zi,
    __wasm_bindgen_func_elem_3286: Qi,
    __wasm_bindgen_func_elem_3286_10: eg,
    __wasm_bindgen_func_elem_3286_3: Xi,
    __wasm_bindgen_func_elem_3286_4: Yi,
    __wasm_bindgen_func_elem_3286_5: Hi,
    __wasm_bindgen_func_elem_3286_7: Ji,
    __wasm_bindgen_func_elem_3286_8: Zi,
    __wasm_bindgen_func_elem_3286_9: _g,
    __wasm_bindgen_func_elem_3287: ji,
    __wasm_bindgen_func_elem_3288: tg,
    __wasm_bindgen_func_elem_3873: Ki,
    __wasm_bindgen_func_elem_3873_11: $i,
    __wasm_bindgen_func_elem_3873_12: Ni,
